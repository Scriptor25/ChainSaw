...
GL_DEPTH_BUFFER_BIT: [const] int32               = 0x00000100;
GL_STENCIL_BUFFER_BIT: [const] int32             = 0x00000400;
GL_COLOR_BUFFER_BIT: [const] int32               = 0x00004000;
GL_FALSE: [const] int32                          = 0;
GL_TRUE: [const] int32                           = 1;
GL_POINTS: [const] int32                         = 0x0000;
GL_LINES: [const] int32                          = 0x0001;
GL_LINE_LOOP: [const] int32                      = 0x0002;
GL_LINE_STRIP: [const] int32                     = 0x0003;
GL_TRIANGLES: [const] int32                      = 0x0004;
GL_TRIANGLE_STRIP: [const] int32                 = 0x0005;
GL_TRIANGLE_FAN: [const] int32                   = 0x0006;
GL_QUADS: [const] int32                          = 0x0007;
GL_NEVER: [const] int32                          = 0x0200;
GL_LESS: [const] int32                           = 0x0201;
GL_EQUAL: [const] int32                          = 0x0202;
GL_LEQUAL: [const] int32                         = 0x0203;
GL_GREATER: [const] int32                        = 0x0204;
GL_NOTEQUAL: [const] int32                       = 0x0205;
GL_GEQUAL: [const] int32                         = 0x0206;
GL_ALWAYS: [const] int32                         = 0x0207;
GL_ZERO: [const] int32                           = 0;
GL_ONE: [const] int32                            = 1;
GL_SRC_COLOR: [const] int32                      = 0x0300;
GL_ONE_MINUS_SRC_COLOR: [const] int32            = 0x0301;
GL_SRC_ALPHA: [const] int32                      = 0x0302;
GL_ONE_MINUS_SRC_ALPHA: [const] int32            = 0x0303;
GL_DST_ALPHA: [const] int32                      = 0x0304;
GL_ONE_MINUS_DST_ALPHA: [const] int32            = 0x0305;
GL_DST_COLOR: [const] int32                      = 0x0306;
GL_ONE_MINUS_DST_COLOR: [const] int32            = 0x0307;
GL_SRC_ALPHA_SATURATE: [const] int32             = 0x0308;
GL_NONE: [const] int32                           = 0;
GL_FRONT_LEFT: [const] int32                     = 0x0400;
GL_FRONT_RIGHT: [const] int32                    = 0x0401;
GL_BACK_LEFT: [const] int32                      = 0x0402;
GL_BACK_RIGHT: [const] int32                     = 0x0403;
GL_FRONT: [const] int32                          = 0x0404;
GL_BACK: [const] int32                           = 0x0405;
GL_LEFT: [const] int32                           = 0x0406;
GL_RIGHT: [const] int32                          = 0x0407;
GL_FRONT_AND_BACK: [const] int32                 = 0x0408;
GL_NO_ERROR: [const] int32                       = 0;
GL_INVALID_ENUM: [const] int32                   = 0x0500;
GL_INVALID_VALUE: [const] int32                  = 0x0501;
GL_INVALID_OPERATION: [const] int32              = 0x0502;
GL_OUT_OF_MEMORY: [const] int32                  = 0x0505;
GL_CW: [const] int32                             = 0x0900;
GL_CCW: [const] int32                            = 0x0901;
GL_POINT_SIZE: [const] int32                     = 0x0B11;
GL_POINT_SIZE_RANGE: [const] int32               = 0x0B12;
GL_POINT_SIZE_GRANULARITY: [const] int32         = 0x0B13;
GL_LINE_SMOOTH: [const] int32                    = 0x0B20;
GL_LINE_WIDTH: [const] int32                     = 0x0B21;
GL_LINE_WIDTH_RANGE: [const] int32               = 0x0B22;
GL_LINE_WIDTH_GRANULARITY: [const] int32         = 0x0B23;
GL_POLYGON_MODE: [const] int32                   = 0x0B40;
GL_POLYGON_SMOOTH: [const] int32                 = 0x0B41;
GL_CULL_FACE: [const] int32                      = 0x0B44;
GL_CULL_FACE_MODE: [const] int32                 = 0x0B45;
GL_FRONT_FACE: [const] int32                     = 0x0B46;
GL_DEPTH_RANGE: [const] int32                    = 0x0B70;
GL_DEPTH_TEST: [const] int32                     = 0x0B71;
GL_DEPTH_WRITEMASK: [const] int32                = 0x0B72;
GL_DEPTH_CLEAR_VALUE: [const] int32              = 0x0B73;
GL_DEPTH_FUNC: [const] int32                     = 0x0B74;
GL_STENCIL_TEST: [const] int32                   = 0x0B90;
GL_STENCIL_CLEAR_VALUE: [const] int32            = 0x0B91;
GL_STENCIL_FUNC: [const] int32                   = 0x0B92;
GL_STENCIL_VALUE_MASK: [const] int32             = 0x0B93;
GL_STENCIL_FAIL: [const] int32                   = 0x0B94;
GL_STENCIL_PASS_DEPTH_FAIL: [const] int32        = 0x0B95;
GL_STENCIL_PASS_DEPTH_PASS: [const] int32        = 0x0B96;
GL_STENCIL_REF: [const] int32                    = 0x0B97;
GL_STENCIL_WRITEMASK: [const] int32              = 0x0B98;
GL_VIEWPORT: [const] int32                       = 0x0BA2;
GL_DITHER: [const] int32                         = 0x0BD0;
GL_BLEND_DST: [const] int32                      = 0x0BE0;
GL_BLEND_SRC: [const] int32                      = 0x0BE1;
GL_BLEND: [const] int32                          = 0x0BE2;
GL_LOGIC_OP_MODE: [const] int32                  = 0x0BF0;
GL_DRAW_BUFFER: [const] int32                    = 0x0C01;
GL_READ_BUFFER: [const] int32                    = 0x0C02;
GL_SCISSOR_BOX: [const] int32                    = 0x0C10;
GL_SCISSOR_TEST: [const] int32                   = 0x0C11;
GL_COLOR_CLEAR_VALUE: [const] int32              = 0x0C22;
GL_COLOR_WRITEMASK: [const] int32                = 0x0C23;
GL_DOUBLEBUFFER: [const] int32                   = 0x0C32;
GL_STEREO: [const] int32                         = 0x0C33;
GL_LINE_SMOOTH_HINT: [const] int32               = 0x0C52;
GL_POLYGON_SMOOTH_HINT: [const] int32            = 0x0C53;
GL_UNPACK_SWAP_BYTES: [const] int32              = 0x0CF0;
GL_UNPACK_LSB_FIRST: [const] int32               = 0x0CF1;
GL_UNPACK_ROW_LENGTH: [const] int32              = 0x0CF2;
GL_UNPACK_SKIP_ROWS: [const] int32               = 0x0CF3;
GL_UNPACK_SKIP_PIXELS: [const] int32             = 0x0CF4;
GL_UNPACK_ALIGNMENT: [const] int32               = 0x0CF5;
GL_PACK_SWAP_BYTES: [const] int32                = 0x0D00;
GL_PACK_LSB_FIRST: [const] int32                 = 0x0D01;
GL_PACK_ROW_LENGTH: [const] int32                = 0x0D02;
GL_PACK_SKIP_ROWS: [const] int32                 = 0x0D03;
GL_PACK_SKIP_PIXELS: [const] int32               = 0x0D04;
GL_PACK_ALIGNMENT: [const] int32                 = 0x0D05;
GL_MAX_TEXTURE_SIZE: [const] int32               = 0x0D33;
GL_MAX_VIEWPORT_DIMS: [const] int32              = 0x0D3A;
GL_SUBPIXEL_BITS: [const] int32                  = 0x0D50;
GL_TEXTURE_1D: [const] int32                     = 0x0DE0;
GL_TEXTURE_2D: [const] int32                     = 0x0DE1;
GL_TEXTURE_WIDTH: [const] int32                  = 0x1000;
GL_TEXTURE_HEIGHT: [const] int32                 = 0x1001;
GL_TEXTURE_BORDER_COLOR: [const] int32           = 0x1004;
GL_DONT_CARE: [const] int32                      = 0x1100;
GL_FASTEST: [const] int32                        = 0x1101;
GL_NICEST: [const] int32                         = 0x1102;
GL_BYTE: [const] int32                           = 0x1400;
GL_UNSIGNED_BYTE: [const] int32                  = 0x1401;
GL_SHORT: [const] int32                          = 0x1402;
GL_UNSIGNED_SHORT: [const] int32                 = 0x1403;
GL_INT: [const] int32                            = 0x1404;
GL_UNSIGNED_INT: [const] int32                   = 0x1405;
GL_FLOAT: [const] int32                          = 0x1406;
GL_STACK_OVERFLOW: [const] int32                 = 0x0503;
GL_STACK_UNDERFLOW: [const] int32                = 0x0504;
GL_CLEAR: [const] int32                          = 0x1500;
GL_AND: [const] int32                            = 0x1501;
GL_AND_REVERSE: [const] int32                    = 0x1502;
GL_COPY: [const] int32                           = 0x1503;
GL_AND_INVERTED: [const] int32                   = 0x1504;
GL_NOOP: [const] int32                           = 0x1505;
GL_XOR: [const] int32                            = 0x1506;
GL_OR: [const] int32                             = 0x1507;
GL_NOR: [const] int32                            = 0x1508;
GL_EQUIV: [const] int32                          = 0x1509;
GL_INVERT: [const] int32                         = 0x150A;
GL_OR_REVERSE: [const] int32                     = 0x150B;
GL_COPY_INVERTED: [const] int32                  = 0x150C;
GL_OR_INVERTED: [const] int32                    = 0x150D;
GL_NAND: [const] int32                           = 0x150E;
GL_SET: [const] int32                            = 0x150F;
GL_TEXTURE: [const] int32                        = 0x1702;
GL_COLOR: [const] int32                          = 0x1800;
GL_DEPTH: [const] int32                          = 0x1801;
GL_STENCIL: [const] int32                        = 0x1802;
GL_STENCIL_INDEX: [const] int32                  = 0x1901;
GL_DEPTH_COMPONENT: [const] int32                = 0x1902;
GL_RED: [const] int32                            = 0x1903;
GL_GREEN: [const] int32                          = 0x1904;
GL_BLUE: [const] int32                           = 0x1905;
GL_ALPHA: [const] int32                          = 0x1906;
GL_RGB: [const] int32                            = 0x1907;
GL_RGBA: [const] int32                           = 0x1908;
GL_POINT: [const] int32                          = 0x1B00;
GL_LINE: [const] int32                           = 0x1B01;
GL_FILL: [const] int32                           = 0x1B02;
GL_KEEP: [const] int32                           = 0x1E00;
GL_REPLACE: [const] int32                        = 0x1E01;
GL_INCR: [const] int32                           = 0x1E02;
GL_DECR: [const] int32                           = 0x1E03;
GL_VENDOR: [const] int32                         = 0x1F00;
GL_RENDERER: [const] int32                       = 0x1F01;
GL_VERSION: [const] int32                        = 0x1F02;
GL_EXTENSIONS: [const] int32                     = 0x1F03;
GL_NEAREST: [const] int32                        = 0x2600;
GL_LINEAR: [const] int32                         = 0x2601;
GL_NEAREST_MIPMAP_NEAREST: [const] int32         = 0x2700;
GL_LINEAR_MIPMAP_NEAREST: [const] int32          = 0x2701;
GL_NEAREST_MIPMAP_LINEAR: [const] int32          = 0x2702;
GL_LINEAR_MIPMAP_LINEAR: [const] int32           = 0x2703;
GL_TEXTURE_MAG_FILTER: [const] int32             = 0x2800;
GL_TEXTURE_MIN_FILTER: [const] int32             = 0x2801;
GL_TEXTURE_WRAP_S: [const] int32                 = 0x2802;
GL_TEXTURE_WRAP_T: [const] int32                 = 0x2803;
GL_REPEAT: [const] int32                         = 0x2901;
...
GL_COLOR_LOGIC_OP: [const] int32                 = 0x0BF2;
GL_POLYGON_OFFSET_UNITS: [const] int32           = 0x2A00;
GL_POLYGON_OFFSET_POINT: [const] int32           = 0x2A01;
GL_POLYGON_OFFSET_LINE: [const] int32            = 0x2A02;
GL_POLYGON_OFFSET_FILL: [const] int32            = 0x8037;
GL_POLYGON_OFFSET_FACTOR: [const] int32          = 0x8038;
GL_TEXTURE_BINDING_1D: [const] int32             = 0x8068;
GL_TEXTURE_BINDING_2D: [const] int32             = 0x8069;
GL_TEXTURE_INTERNAL_FORMAT: [const] int32        = 0x1003;
GL_TEXTURE_RED_SIZE: [const] int32               = 0x805C;
GL_TEXTURE_GREEN_SIZE: [const] int32             = 0x805D;
GL_TEXTURE_BLUE_SIZE: [const] int32              = 0x805E;
GL_TEXTURE_ALPHA_SIZE: [const] int32             = 0x805F;
GL_DOUBLE: [const] int32                         = 0x140A;
GL_PROXY_TEXTURE_1D: [const] int32               = 0x8063;
GL_PROXY_TEXTURE_2D: [const] int32               = 0x8064;
GL_R3_G3_B2: [const] int32                       = 0x2A10;
GL_RGB4: [const] int32                           = 0x804F;
GL_RGB5: [const] int32                           = 0x8050;
GL_RGB8: [const] int32                           = 0x8051;
GL_RGB10: [const] int32                          = 0x8052;
GL_RGB12: [const] int32                          = 0x8053;
GL_RGB16: [const] int32                          = 0x8054;
GL_RGBA2: [const] int32                          = 0x8055;
GL_RGBA4: [const] int32                          = 0x8056;
GL_RGB5_A1: [const] int32                        = 0x8057;
GL_RGBA8: [const] int32                          = 0x8058;
GL_RGB10_A2: [const] int32                       = 0x8059;
GL_RGBA12: [const] int32                         = 0x805A;
GL_RGBA16: [const] int32                         = 0x805B;
GL_VERTEX_ARRAY: [const] int32                   = 0x8074;
...
GL_UNSIGNED_BYTE_3_3_2: [const] int32            = 0x8032;
GL_UNSIGNED_SHORT_4_4_4_4: [const] int32         = 0x8033;
GL_UNSIGNED_SHORT_5_5_5_1: [const] int32         = 0x8034;
GL_UNSIGNED_INT_8_8_8_8: [const] int32           = 0x8035;
GL_UNSIGNED_INT_10_10_10_2: [const] int32        = 0x8036;
GL_TEXTURE_BINDING_3D: [const] int32             = 0x806A;
GL_PACK_SKIP_IMAGES: [const] int32               = 0x806B;
GL_PACK_IMAGE_HEIGHT: [const] int32              = 0x806C;
GL_UNPACK_SKIP_IMAGES: [const] int32             = 0x806D;
GL_UNPACK_IMAGE_HEIGHT: [const] int32            = 0x806E;
GL_TEXTURE_3D: [const] int32                     = 0x806F;
GL_PROXY_TEXTURE_3D: [const] int32               = 0x8070;
GL_TEXTURE_DEPTH: [const] int32                  = 0x8071;
GL_TEXTURE_WRAP_R: [const] int32                 = 0x8072;
GL_MAX_3D_TEXTURE_SIZE: [const] int32            = 0x8073;
GL_UNSIGNED_BYTE_2_3_3_REV: [const] int32        = 0x8362;
GL_UNSIGNED_SHORT_5_6_5: [const] int32           = 0x8363;
GL_UNSIGNED_SHORT_5_6_5_REV: [const] int32       = 0x8364;
GL_UNSIGNED_SHORT_4_4_4_4_REV: [const] int32     = 0x8365;
GL_UNSIGNED_SHORT_1_5_5_5_REV: [const] int32     = 0x8366;
GL_UNSIGNED_INT_8_8_8_8_REV: [const] int32       = 0x8367;
GL_UNSIGNED_INT_2_10_10_10_REV: [const] int32    = 0x8368;
GL_BGR: [const] int32                            = 0x80E0;
GL_BGRA: [const] int32                           = 0x80E1;
GL_MAX_ELEMENTS_VERTICES: [const] int32          = 0x80E8;
GL_MAX_ELEMENTS_INDICES: [const] int32           = 0x80E9;
GL_CLAMP_TO_EDGE: [const] int32                  = 0x812F;
GL_TEXTURE_MIN_LOD: [const] int32                = 0x813A;
GL_TEXTURE_MAX_LOD: [const] int32                = 0x813B;
GL_TEXTURE_BASE_LEVEL: [const] int32             = 0x813C;
GL_TEXTURE_MAX_LEVEL: [const] int32              = 0x813D;
GL_SMOOTH_POINT_SIZE_RANGE: [const] int32        = 0x0B12;
GL_SMOOTH_POINT_SIZE_GRANULARITY: [const] int32  = 0x0B13;
GL_SMOOTH_LINE_WIDTH_RANGE: [const] int32        = 0x0B22;
GL_SMOOTH_LINE_WIDTH_GRANULARITY: [const] int32  = 0x0B23;
GL_ALIASED_LINE_WIDTH_RANGE: [const] int32       = 0x846E;
...
GL_TEXTURE0: [const] int32                       = 0x84C0;
GL_TEXTURE1: [const] int32                       = 0x84C1;
GL_TEXTURE2: [const] int32                       = 0x84C2;
GL_TEXTURE3: [const] int32                       = 0x84C3;
GL_TEXTURE4: [const] int32                       = 0x84C4;
GL_TEXTURE5: [const] int32                       = 0x84C5;
GL_TEXTURE6: [const] int32                       = 0x84C6;
GL_TEXTURE7: [const] int32                       = 0x84C7;
GL_TEXTURE8: [const] int32                       = 0x84C8;
GL_TEXTURE9: [const] int32                       = 0x84C9;
GL_TEXTURE10: [const] int32                      = 0x84CA;
GL_TEXTURE11: [const] int32                      = 0x84CB;
GL_TEXTURE12: [const] int32                      = 0x84CC;
GL_TEXTURE13: [const] int32                      = 0x84CD;
GL_TEXTURE14: [const] int32                      = 0x84CE;
GL_TEXTURE15: [const] int32                      = 0x84CF;
GL_TEXTURE16: [const] int32                      = 0x84D0;
GL_TEXTURE17: [const] int32                      = 0x84D1;
GL_TEXTURE18: [const] int32                      = 0x84D2;
GL_TEXTURE19: [const] int32                      = 0x84D3;
GL_TEXTURE20: [const] int32                      = 0x84D4;
GL_TEXTURE21: [const] int32                      = 0x84D5;
GL_TEXTURE22: [const] int32                      = 0x84D6;
GL_TEXTURE23: [const] int32                      = 0x84D7;
GL_TEXTURE24: [const] int32                      = 0x84D8;
GL_TEXTURE25: [const] int32                      = 0x84D9;
GL_TEXTURE26: [const] int32                      = 0x84DA;
GL_TEXTURE27: [const] int32                      = 0x84DB;
GL_TEXTURE28: [const] int32                      = 0x84DC;
GL_TEXTURE29: [const] int32                      = 0x84DD;
GL_TEXTURE30: [const] int32                      = 0x84DE;
GL_TEXTURE31: [const] int32                      = 0x84DF;
GL_ACTIVE_TEXTURE: [const] int32                 = 0x84E0;
GL_MULTISAMPLE: [const] int32                    = 0x809D;
GL_SAMPLE_ALPHA_TO_COVERAGE: [const] int32       = 0x809E;
GL_SAMPLE_ALPHA_TO_ONE: [const] int32            = 0x809F;
GL_SAMPLE_COVERAGE: [const] int32                = 0x80A0;
GL_SAMPLE_BUFFERS: [const] int32                 = 0x80A8;
GL_SAMPLES: [const] int32                        = 0x80A9;
GL_SAMPLE_COVERAGE_VALUE: [const] int32          = 0x80AA;
GL_SAMPLE_COVERAGE_INVERT: [const] int32         = 0x80AB;
GL_TEXTURE_CUBE_MAP: [const] int32               = 0x8513;
GL_TEXTURE_BINDING_CUBE_MAP: [const] int32       = 0x8514;
GL_TEXTURE_CUBE_MAP_POSITIVE_X: [const] int32    = 0x8515;
GL_TEXTURE_CUBE_MAP_NEGATIVE_X: [const] int32    = 0x8516;
GL_TEXTURE_CUBE_MAP_POSITIVE_Y: [const] int32    = 0x8517;
GL_TEXTURE_CUBE_MAP_NEGATIVE_Y: [const] int32    = 0x8518;
GL_TEXTURE_CUBE_MAP_POSITIVE_Z: [const] int32    = 0x8519;
GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: [const] int32    = 0x851A;
GL_PROXY_TEXTURE_CUBE_MAP: [const] int32         = 0x851B;
GL_MAX_CUBE_MAP_TEXTURE_SIZE: [const] int32      = 0x851C;
GL_COMPRESSED_RGB: [const] int32                 = 0x84ED;
GL_COMPRESSED_RGBA: [const] int32                = 0x84EE;
GL_TEXTURE_COMPRESSION_HINT: [const] int32       = 0x84EF;
GL_TEXTURE_COMPRESSED_IMAGE_SIZE: [const] int32  = 0x86A0;
GL_TEXTURE_COMPRESSED: [const] int32             = 0x86A1;
GL_NUM_COMPRESSED_TEXTURE_FORMATS: [const] int32 = 0x86A2;
GL_COMPRESSED_TEXTURE_FORMATS: [const] int32     = 0x86A3;
GL_CLAMP_TO_BORDER: [const] int32                = 0x812D;
...
GL_BLEND_DST_RGB: [const] int32                  = 0x80C8;
GL_BLEND_SRC_RGB: [const] int32                  = 0x80C9;
GL_BLEND_DST_ALPHA: [const] int32                = 0x80CA;
GL_BLEND_SRC_ALPHA: [const] int32                = 0x80CB;
GL_POINT_FADE_THRESHOLD_SIZE: [const] int32      = 0x8128;
GL_DEPTH_COMPONENT16: [const] int32              = 0x81A5;
GL_DEPTH_COMPONENT24: [const] int32              = 0x81A6;
GL_DEPTH_COMPONENT32: [const] int32              = 0x81A7;
GL_MIRRORED_REPEAT: [const] int32                = 0x8370;
GL_MAX_TEXTURE_LOD_BIAS: [const] int32           = 0x84FD;
GL_TEXTURE_LOD_BIAS: [const] int32               = 0x8501;
GL_INCR_WRAP: [const] int32                      = 0x8507;
GL_DECR_WRAP: [const] int32                      = 0x8508;
GL_TEXTURE_DEPTH_SIZE: [const] int32             = 0x884A;
GL_TEXTURE_COMPARE_MODE: [const] int32           = 0x884C;
GL_TEXTURE_COMPARE_FUNC: [const] int32           = 0x884D;
GL_BLEND_COLOR: [const] int32                    = 0x8005;
GL_BLEND_EQUATION: [const] int32                 = 0x8009;
GL_CONSTANT_COLOR: [const] int32                 = 0x8001;
GL_ONE_MINUS_CONSTANT_COLOR: [const] int32       = 0x8002;
GL_CONSTANT_ALPHA: [const] int32                 = 0x8003;
GL_ONE_MINUS_CONSTANT_ALPHA: [const] int32       = 0x8004;
GL_FUNC_ADD: [const] int32                       = 0x8006;
GL_FUNC_REVERSE_SUBTRACT: [const] int32          = 0x800B;
GL_FUNC_SUBTRACT: [const] int32                  = 0x800A;
GL_MIN: [const] int32                            = 0x8007;
GL_MAX: [const] int32                            = 0x8008;
...
GL_BUFFER_SIZE: [const] int32                    = 0x8764;
GL_BUFFER_USAGE: [const] int32                   = 0x8765;
GL_QUERY_COUNTER_BITS: [const] int32             = 0x8864;
GL_CURRENT_QUERY: [const] int32                  = 0x8865;
GL_QUERY_RESULT: [const] int32                   = 0x8866;
GL_QUERY_RESULT_AVAILABLE: [const] int32         = 0x8867;
GL_ARRAY_BUFFER: [const] int32                   = 0x8892;
GL_ELEMENT_ARRAY_BUFFER: [const] int32           = 0x8893;
GL_ARRAY_BUFFER_BINDING: [const] int32           = 0x8894;
GL_ELEMENT_ARRAY_BUFFER_BINDING: [const] int32   = 0x8895;
GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING: [const] int32 = 0x889F;
GL_READ_ONLY: [const] int32                      = 0x88B8;
GL_WRITE_ONLY: [const] int32                     = 0x88B9;
GL_READ_WRITE: [const] int32                     = 0x88BA;
GL_BUFFER_ACCESS: [const] int32                  = 0x88BB;
GL_BUFFER_MAPPED: [const] int32                  = 0x88BC;
GL_BUFFER_MAP_POINTER: [const] int32             = 0x88BD;
GL_STREAM_DRAW: [const] int32                    = 0x88E0;
GL_STREAM_READ: [const] int32                    = 0x88E1;
GL_STREAM_COPY: [const] int32                    = 0x88E2;
GL_STATIC_DRAW: [const] int32                    = 0x88E4;
GL_STATIC_READ: [const] int32                    = 0x88E5;
GL_STATIC_COPY: [const] int32                    = 0x88E6;
GL_DYNAMIC_DRAW: [const] int32                   = 0x88E8;
GL_DYNAMIC_READ: [const] int32                   = 0x88E9;
GL_DYNAMIC_COPY: [const] int32                   = 0x88EA;
GL_SAMPLES_PASSED: [const] int32                 = 0x8914;
GL_SRC1_ALPHA: [const] int32                     = 0x8589;
...
GL_BLEND_EQUATION_RGB: [const] int32             = 0x8009;
GL_VERTEX_ATTRIB_ARRAY_ENABLED: [const] int32    = 0x8622;
GL_VERTEX_ATTRIB_ARRAY_SIZE: [const] int32       = 0x8623;
GL_VERTEX_ATTRIB_ARRAY_STRIDE: [const] int32     = 0x8624;
GL_VERTEX_ATTRIB_ARRAY_TYPE: [const] int32       = 0x8625;
GL_CURRENT_VERTEX_ATTRIB: [const] int32          = 0x8626;
GL_VERTEX_PROGRAM_POINT_SIZE: [const] int32      = 0x8642;
GL_VERTEX_ATTRIB_ARRAY_POINTER: [const] int32    = 0x8645;
GL_STENCIL_BACK_FUNC: [const] int32              = 0x8800;
GL_STENCIL_BACK_FAIL: [const] int32              = 0x8801;
GL_STENCIL_BACK_PASS_DEPTH_FAIL: [const] int32   = 0x8802;
GL_STENCIL_BACK_PASS_DEPTH_PASS: [const] int32   = 0x8803;
GL_MAX_DRAW_BUFFERS: [const] int32               = 0x8824;
GL_DRAW_BUFFER0: [const] int32                   = 0x8825;
GL_DRAW_BUFFER1: [const] int32                   = 0x8826;
GL_DRAW_BUFFER2: [const] int32                   = 0x8827;
GL_DRAW_BUFFER3: [const] int32                   = 0x8828;
GL_DRAW_BUFFER4: [const] int32                   = 0x8829;
GL_DRAW_BUFFER5: [const] int32                   = 0x882A;
GL_DRAW_BUFFER6: [const] int32                   = 0x882B;
GL_DRAW_BUFFER7: [const] int32                   = 0x882C;
GL_DRAW_BUFFER8: [const] int32                   = 0x882D;
GL_DRAW_BUFFER9: [const] int32                   = 0x882E;
GL_DRAW_BUFFER10: [const] int32                  = 0x882F;
GL_DRAW_BUFFER11: [const] int32                  = 0x8830;
GL_DRAW_BUFFER12: [const] int32                  = 0x8831;
GL_DRAW_BUFFER13: [const] int32                  = 0x8832;
GL_DRAW_BUFFER14: [const] int32                  = 0x8833;
GL_DRAW_BUFFER15: [const] int32                  = 0x8834;
GL_BLEND_EQUATION_ALPHA: [const] int32           = 0x883D;
GL_MAX_VERTEX_ATTRIBS: [const] int32             = 0x8869;
GL_VERTEX_ATTRIB_ARRAY_NORMALIZED: [const] int32 = 0x886A;
GL_MAX_TEXTURE_IMAGE_UNITS: [const] int32        = 0x8872;
GL_FRAGMENT_SHADER: [const] int32                = 0x8B30;
GL_VERTEX_SHADER: [const] int32                  = 0x8B31;
GL_MAX_FRAGMENT_UNIFORM_COMPONENTS: [const] int32 = 0x8B49;
GL_MAX_VERTEX_UNIFORM_COMPONENTS: [const] int32  = 0x8B4A;
GL_MAX_VARYING_FLOATS: [const] int32             = 0x8B4B;
GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS: [const] int32 = 0x8B4C;
GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS: [const] int32 = 0x8B4D;
GL_SHADER_TYPE: [const] int32                    = 0x8B4F;
GL_FLOAT_VEC2: [const] int32                     = 0x8B50;
GL_FLOAT_VEC3: [const] int32                     = 0x8B51;
GL_FLOAT_VEC4: [const] int32                     = 0x8B52;
GL_INT_VEC2: [const] int32                       = 0x8B53;
GL_INT_VEC3: [const] int32                       = 0x8B54;
GL_INT_VEC4: [const] int32                       = 0x8B55;
GL_BOOL: [const] int32                           = 0x8B56;
GL_BOOL_VEC2: [const] int32                      = 0x8B57;
GL_BOOL_VEC3: [const] int32                      = 0x8B58;
GL_BOOL_VEC4: [const] int32                      = 0x8B59;
GL_FLOAT_MAT2: [const] int32                     = 0x8B5A;
GL_FLOAT_MAT3: [const] int32                     = 0x8B5B;
GL_FLOAT_MAT4: [const] int32                     = 0x8B5C;
GL_SAMPLER_1D: [const] int32                     = 0x8B5D;
GL_SAMPLER_2D: [const] int32                     = 0x8B5E;
GL_SAMPLER_3D: [const] int32                     = 0x8B5F;
GL_SAMPLER_CUBE: [const] int32                   = 0x8B60;
GL_SAMPLER_1D_SHADOW: [const] int32              = 0x8B61;
GL_SAMPLER_2D_SHADOW: [const] int32              = 0x8B62;
GL_DELETE_STATUS: [const] int32                  = 0x8B80;
GL_COMPILE_STATUS: [const] int32                 = 0x8B81;
GL_LINK_STATUS: [const] int32                    = 0x8B82;
GL_VALIDATE_STATUS: [const] int32                = 0x8B83;
GL_INFO_LOG_LENGTH: [const] int32                = 0x8B84;
GL_ATTACHED_SHADERS: [const] int32               = 0x8B85;
GL_ACTIVE_UNIFORMS: [const] int32                = 0x8B86;
GL_ACTIVE_UNIFORM_MAX_LENGTH: [const] int32      = 0x8B87;
GL_SHADER_SOURCE_LENGTH: [const] int32           = 0x8B88;
GL_ACTIVE_ATTRIBUTES: [const] int32              = 0x8B89;
GL_ACTIVE_ATTRIBUTE_MAX_LENGTH: [const] int32    = 0x8B8A;
GL_FRAGMENT_SHADER_DERIVATIVE_HINT: [const] int32 = 0x8B8B;
GL_SHADING_LANGUAGE_VERSION: [const] int32       = 0x8B8C;
GL_CURRENT_PROGRAM: [const] int32                = 0x8B8D;
GL_POINT_SPRITE_COORD_ORIGIN: [const] int32      = 0x8CA0;
GL_LOWER_LEFT: [const] int32                     = 0x8CA1;
GL_UPPER_LEFT: [const] int32                     = 0x8CA2;
GL_STENCIL_BACK_REF: [const] int32               = 0x8CA3;
GL_STENCIL_BACK_VALUE_MASK: [const] int32        = 0x8CA4;
GL_STENCIL_BACK_WRITEMASK: [const] int32         = 0x8CA5;
...
GL_PIXEL_PACK_BUFFER: [const] int32              = 0x88EB;
GL_PIXEL_UNPACK_BUFFER: [const] int32            = 0x88EC;
GL_PIXEL_PACK_BUFFER_BINDING: [const] int32      = 0x88ED;
GL_PIXEL_UNPACK_BUFFER_BINDING: [const] int32    = 0x88EF;
GL_FLOAT_MAT2x3: [const] int32                   = 0x8B65;
GL_FLOAT_MAT2x4: [const] int32                   = 0x8B66;
GL_FLOAT_MAT3x2: [const] int32                   = 0x8B67;
GL_FLOAT_MAT3x4: [const] int32                   = 0x8B68;
GL_FLOAT_MAT4x2: [const] int32                   = 0x8B69;
GL_FLOAT_MAT4x3: [const] int32                   = 0x8B6A;
GL_SRGB: [const] int32                           = 0x8C40;
GL_SRGB8: [const] int32                          = 0x8C41;
GL_SRGB_ALPHA: [const] int32                     = 0x8C42;
GL_SRGB8_ALPHA8: [const] int32                   = 0x8C43;
GL_COMPRESSED_SRGB: [const] int32                = 0x8C48;
GL_COMPRESSED_SRGB_ALPHA: [const] int32          = 0x8C49;
...
GL_COMPARE_REF_TO_TEXTURE: [const] int32         = 0x884E;
GL_CLIP_DISTANCE0: [const] int32                 = 0x3000;
GL_CLIP_DISTANCE1: [const] int32                 = 0x3001;
GL_CLIP_DISTANCE2: [const] int32                 = 0x3002;
GL_CLIP_DISTANCE3: [const] int32                 = 0x3003;
GL_CLIP_DISTANCE4: [const] int32                 = 0x3004;
GL_CLIP_DISTANCE5: [const] int32                 = 0x3005;
GL_CLIP_DISTANCE6: [const] int32                 = 0x3006;
GL_CLIP_DISTANCE7: [const] int32                 = 0x3007;
GL_MAX_CLIP_DISTANCES: [const] int32             = 0x0D32;
GL_MAJOR_VERSION: [const] int32                  = 0x821B;
GL_MINOR_VERSION: [const] int32                  = 0x821C;
GL_NUM_EXTENSIONS: [const] int32                 = 0x821D;
GL_CONTEXT_FLAGS: [const] int32                  = 0x821E;
GL_COMPRESSED_RED: [const] int32                 = 0x8225;
GL_COMPRESSED_RG: [const] int32                  = 0x8226;
GL_CONTEXT_FLAG_FORWARD_COMPATIBLE_BIT: [const] int32 = 0x00000001;
GL_RGBA32F: [const] int32                        = 0x8814;
GL_RGB32F: [const] int32                         = 0x8815;
GL_RGBA16F: [const] int32                        = 0x881A;
GL_RGB16F: [const] int32                         = 0x881B;
GL_VERTEX_ATTRIB_ARRAY_INTEGER: [const] int32    = 0x88FD;
GL_MAX_ARRAY_TEXTURE_LAYERS: [const] int32       = 0x88FF;
GL_MIN_PROGRAM_TEXEL_OFFSET: [const] int32       = 0x8904;
GL_MAX_PROGRAM_TEXEL_OFFSET: [const] int32       = 0x8905;
GL_CLAMP_READ_COLOR: [const] int32               = 0x891C;
GL_FIXED_ONLY: [const] int32                     = 0x891D;
GL_MAX_VARYING_COMPONENTS: [const] int32         = 0x8B4B;
GL_TEXTURE_1D_ARRAY: [const] int32               = 0x8C18;
GL_PROXY_TEXTURE_1D_ARRAY: [const] int32         = 0x8C19;
GL_TEXTURE_2D_ARRAY: [const] int32               = 0x8C1A;
GL_PROXY_TEXTURE_2D_ARRAY: [const] int32         = 0x8C1B;
GL_TEXTURE_BINDING_1D_ARRAY: [const] int32       = 0x8C1C;
GL_TEXTURE_BINDING_2D_ARRAY: [const] int32       = 0x8C1D;
GL_R11F_G11F_B10F: [const] int32                 = 0x8C3A;
GL_UNSIGNED_INT_10F_11F_11F_REV: [const] int32   = 0x8C3B;
GL_RGB9_E5: [const] int32                        = 0x8C3D;
GL_UNSIGNED_INT_5_9_9_9_REV: [const] int32       = 0x8C3E;
GL_TEXTURE_SHARED_SIZE: [const] int32            = 0x8C3F;
GL_TRANSFORM_FEEDBACK_VARYING_MAX_LENGTH: [const] int32 = 0x8C76;
GL_TRANSFORM_FEEDBACK_BUFFER_MODE: [const] int32 = 0x8C7F;
GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS: [const] int32 = 0x8C80;
GL_TRANSFORM_FEEDBACK_VARYINGS: [const] int32    = 0x8C83;
GL_TRANSFORM_FEEDBACK_BUFFER_START: [const] int32 = 0x8C84;
GL_TRANSFORM_FEEDBACK_BUFFER_SIZE: [const] int32 = 0x8C85;
GL_PRIMITIVES_GENERATED: [const] int32           = 0x8C87;
GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN: [const] int32 = 0x8C88;
GL_RASTERIZER_DISCARD: [const] int32             = 0x8C89;
GL_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS: [const] int32 = 0x8C8A;
GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS: [const] int32 = 0x8C8B;
GL_INTERLEAVED_ATTRIBS: [const] int32            = 0x8C8C;
GL_SEPARATE_ATTRIBS: [const] int32               = 0x8C8D;
GL_TRANSFORM_FEEDBACK_BUFFER: [const] int32      = 0x8C8E;
GL_TRANSFORM_FEEDBACK_BUFFER_BINDING: [const] int32 = 0x8C8F;
GL_RGBA32UI: [const] int32                       = 0x8D70;
GL_RGB32UI: [const] int32                        = 0x8D71;
GL_RGBA16UI: [const] int32                       = 0x8D76;
GL_RGB16UI: [const] int32                        = 0x8D77;
GL_RGBA8UI: [const] int32                        = 0x8D7C;
GL_RGB8UI: [const] int32                         = 0x8D7D;
GL_RGBA32I: [const] int32                        = 0x8D82;
GL_RGB32I: [const] int32                         = 0x8D83;
GL_RGBA16I: [const] int32                        = 0x8D88;
GL_RGB16I: [const] int32                         = 0x8D89;
GL_RGBA8I: [const] int32                         = 0x8D8E;
GL_RGB8I: [const] int32                          = 0x8D8F;
GL_RED_INTEGER: [const] int32                    = 0x8D94;
GL_GREEN_INTEGER: [const] int32                  = 0x8D95;
GL_BLUE_INTEGER: [const] int32                   = 0x8D96;
GL_RGB_INTEGER: [const] int32                    = 0x8D98;
GL_RGBA_INTEGER: [const] int32                   = 0x8D99;
GL_BGR_INTEGER: [const] int32                    = 0x8D9A;
GL_BGRA_INTEGER: [const] int32                   = 0x8D9B;
GL_SAMPLER_1D_ARRAY: [const] int32               = 0x8DC0;
GL_SAMPLER_2D_ARRAY: [const] int32               = 0x8DC1;
GL_SAMPLER_1D_ARRAY_SHADOW: [const] int32        = 0x8DC3;
GL_SAMPLER_2D_ARRAY_SHADOW: [const] int32        = 0x8DC4;
GL_SAMPLER_CUBE_SHADOW: [const] int32            = 0x8DC5;
GL_UNSIGNED_INT_VEC2: [const] int32              = 0x8DC6;
GL_UNSIGNED_INT_VEC3: [const] int32              = 0x8DC7;
GL_UNSIGNED_INT_VEC4: [const] int32              = 0x8DC8;
GL_INT_SAMPLER_1D: [const] int32                 = 0x8DC9;
GL_INT_SAMPLER_2D: [const] int32                 = 0x8DCA;
GL_INT_SAMPLER_3D: [const] int32                 = 0x8DCB;
GL_INT_SAMPLER_CUBE: [const] int32               = 0x8DCC;
GL_INT_SAMPLER_1D_ARRAY: [const] int32           = 0x8DCE;
GL_INT_SAMPLER_2D_ARRAY: [const] int32           = 0x8DCF;
GL_UNSIGNED_INT_SAMPLER_1D: [const] int32        = 0x8DD1;
GL_UNSIGNED_INT_SAMPLER_2D: [const] int32        = 0x8DD2;
GL_UNSIGNED_INT_SAMPLER_3D: [const] int32        = 0x8DD3;
GL_UNSIGNED_INT_SAMPLER_CUBE: [const] int32      = 0x8DD4;
GL_UNSIGNED_INT_SAMPLER_1D_ARRAY: [const] int32  = 0x8DD6;
GL_UNSIGNED_INT_SAMPLER_2D_ARRAY: [const] int32  = 0x8DD7;
GL_QUERY_WAIT: [const] int32                     = 0x8E13;
GL_QUERY_NO_WAIT: [const] int32                  = 0x8E14;
GL_QUERY_BY_REGION_WAIT: [const] int32           = 0x8E15;
GL_QUERY_BY_REGION_NO_WAIT: [const] int32        = 0x8E16;
GL_BUFFER_ACCESS_FLAGS: [const] int32            = 0x911F;
GL_BUFFER_MAP_LENGTH: [const] int32              = 0x9120;
GL_BUFFER_MAP_OFFSET: [const] int32              = 0x9121;
GL_DEPTH_COMPONENT32F: [const] int32             = 0x8CAC;
GL_DEPTH32F_STENCIL8: [const] int32              = 0x8CAD;
GL_FLOAT_32_UNSIGNED_INT_24_8_REV: [const] int32 = 0x8DAD;
GL_INVALID_FRAMEBUFFER_OPERATION: [const] int32  = 0x0506;
GL_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING: [const] int32 = 0x8210;
GL_FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE: [const] int32 = 0x8211;
GL_FRAMEBUFFER_ATTACHMENT_RED_SIZE: [const] int32 = 0x8212;
GL_FRAMEBUFFER_ATTACHMENT_GREEN_SIZE: [const] int32 = 0x8213;
GL_FRAMEBUFFER_ATTACHMENT_BLUE_SIZE: [const] int32 = 0x8214;
GL_FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE: [const] int32 = 0x8215;
GL_FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE: [const] int32 = 0x8216;
GL_FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE: [const] int32 = 0x8217;
GL_FRAMEBUFFER_DEFAULT: [const] int32            = 0x8218;
GL_FRAMEBUFFER_UNDEFINED: [const] int32          = 0x8219;
GL_DEPTH_STENCIL_ATTACHMENT: [const] int32       = 0x821A;
GL_MAX_RENDERBUFFER_SIZE: [const] int32          = 0x84E8;
GL_DEPTH_STENCIL: [const] int32                  = 0x84F9;
GL_UNSIGNED_INT_24_8: [const] int32              = 0x84FA;
GL_DEPTH24_STENCIL8: [const] int32               = 0x88F0;
GL_TEXTURE_STENCIL_SIZE: [const] int32           = 0x88F1;
GL_TEXTURE_RED_TYPE: [const] int32               = 0x8C10;
GL_TEXTURE_GREEN_TYPE: [const] int32             = 0x8C11;
GL_TEXTURE_BLUE_TYPE: [const] int32              = 0x8C12;
GL_TEXTURE_ALPHA_TYPE: [const] int32             = 0x8C13;
GL_TEXTURE_DEPTH_TYPE: [const] int32             = 0x8C16;
GL_UNSIGNED_NORMALIZED: [const] int32            = 0x8C17;
GL_FRAMEBUFFER_BINDING: [const] int32            = 0x8CA6;
GL_DRAW_FRAMEBUFFER_BINDING: [const] int32       = 0x8CA6;
GL_RENDERBUFFER_BINDING: [const] int32           = 0x8CA7;
GL_READ_FRAMEBUFFER: [const] int32               = 0x8CA8;
GL_DRAW_FRAMEBUFFER: [const] int32               = 0x8CA9;
GL_READ_FRAMEBUFFER_BINDING: [const] int32       = 0x8CAA;
GL_RENDERBUFFER_SAMPLES: [const] int32           = 0x8CAB;
GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE: [const] int32 = 0x8CD0;
GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME: [const] int32 = 0x8CD1;
GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL: [const] int32 = 0x8CD2;
GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE: [const] int32 = 0x8CD3;
GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER: [const] int32 = 0x8CD4;
GL_FRAMEBUFFER_COMPLETE: [const] int32           = 0x8CD5;
GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT: [const] int32 = 0x8CD6;
GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT: [const] int32 = 0x8CD7;
GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER: [const] int32 = 0x8CDB;
GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER: [const] int32 = 0x8CDC;
GL_FRAMEBUFFER_UNSUPPORTED: [const] int32        = 0x8CDD;
GL_MAX_COLOR_ATTACHMENTS: [const] int32          = 0x8CDF;
GL_COLOR_ATTACHMENT0: [const] int32              = 0x8CE0;
GL_COLOR_ATTACHMENT1: [const] int32              = 0x8CE1;
GL_COLOR_ATTACHMENT2: [const] int32              = 0x8CE2;
GL_COLOR_ATTACHMENT3: [const] int32              = 0x8CE3;
GL_COLOR_ATTACHMENT4: [const] int32              = 0x8CE4;
GL_COLOR_ATTACHMENT5: [const] int32              = 0x8CE5;
GL_COLOR_ATTACHMENT6: [const] int32              = 0x8CE6;
GL_COLOR_ATTACHMENT7: [const] int32              = 0x8CE7;
GL_COLOR_ATTACHMENT8: [const] int32              = 0x8CE8;
GL_COLOR_ATTACHMENT9: [const] int32              = 0x8CE9;
GL_COLOR_ATTACHMENT10: [const] int32             = 0x8CEA;
GL_COLOR_ATTACHMENT11: [const] int32             = 0x8CEB;
GL_COLOR_ATTACHMENT12: [const] int32             = 0x8CEC;
GL_COLOR_ATTACHMENT13: [const] int32             = 0x8CED;
GL_COLOR_ATTACHMENT14: [const] int32             = 0x8CEE;
GL_COLOR_ATTACHMENT15: [const] int32             = 0x8CEF;
GL_COLOR_ATTACHMENT16: [const] int32             = 0x8CF0;
GL_COLOR_ATTACHMENT17: [const] int32             = 0x8CF1;
GL_COLOR_ATTACHMENT18: [const] int32             = 0x8CF2;
GL_COLOR_ATTACHMENT19: [const] int32             = 0x8CF3;
GL_COLOR_ATTACHMENT20: [const] int32             = 0x8CF4;
GL_COLOR_ATTACHMENT21: [const] int32             = 0x8CF5;
GL_COLOR_ATTACHMENT22: [const] int32             = 0x8CF6;
GL_COLOR_ATTACHMENT23: [const] int32             = 0x8CF7;
GL_COLOR_ATTACHMENT24: [const] int32             = 0x8CF8;
GL_COLOR_ATTACHMENT25: [const] int32             = 0x8CF9;
GL_COLOR_ATTACHMENT26: [const] int32             = 0x8CFA;
GL_COLOR_ATTACHMENT27: [const] int32             = 0x8CFB;
GL_COLOR_ATTACHMENT28: [const] int32             = 0x8CFC;
GL_COLOR_ATTACHMENT29: [const] int32             = 0x8CFD;
GL_COLOR_ATTACHMENT30: [const] int32             = 0x8CFE;
GL_COLOR_ATTACHMENT31: [const] int32             = 0x8CFF;
GL_DEPTH_ATTACHMENT: [const] int32               = 0x8D00;
GL_STENCIL_ATTACHMENT: [const] int32             = 0x8D20;
GL_FRAMEBUFFER: [const] int32                    = 0x8D40;
GL_RENDERBUFFER: [const] int32                   = 0x8D41;
GL_RENDERBUFFER_WIDTH: [const] int32             = 0x8D42;
GL_RENDERBUFFER_HEIGHT: [const] int32            = 0x8D43;
GL_RENDERBUFFER_INTERNAL_FORMAT: [const] int32   = 0x8D44;
GL_STENCIL_INDEX1: [const] int32                 = 0x8D46;
GL_STENCIL_INDEX4: [const] int32                 = 0x8D47;
GL_STENCIL_INDEX8: [const] int32                 = 0x8D48;
GL_STENCIL_INDEX16: [const] int32                = 0x8D49;
GL_RENDERBUFFER_RED_SIZE: [const] int32          = 0x8D50;
GL_RENDERBUFFER_GREEN_SIZE: [const] int32        = 0x8D51;
GL_RENDERBUFFER_BLUE_SIZE: [const] int32         = 0x8D52;
GL_RENDERBUFFER_ALPHA_SIZE: [const] int32        = 0x8D53;
GL_RENDERBUFFER_DEPTH_SIZE: [const] int32        = 0x8D54;
GL_RENDERBUFFER_STENCIL_SIZE: [const] int32      = 0x8D55;
GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE: [const] int32 = 0x8D56;
GL_MAX_SAMPLES: [const] int32                    = 0x8D57;
GL_FRAMEBUFFER_SRGB: [const] int32               = 0x8DB9;
GL_HALF_FLOAT: [const] int32                     = 0x140B;
GL_MAP_READ_BIT: [const] int32                   = 0x0001;
GL_MAP_WRITE_BIT: [const] int32                  = 0x0002;
GL_MAP_INVALIDATE_RANGE_BIT: [const] int32       = 0x0004;
GL_MAP_INVALIDATE_BUFFER_BIT: [const] int32      = 0x0008;
GL_MAP_FLUSH_EXPLICIT_BIT: [const] int32         = 0x0010;
GL_MAP_UNSYNCHRONIZED_BIT: [const] int32         = 0x0020;
GL_COMPRESSED_RED_RGTC1: [const] int32           = 0x8DBB;
GL_COMPRESSED_SIGNED_RED_RGTC1: [const] int32    = 0x8DBC;
GL_COMPRESSED_RG_RGTC2: [const] int32            = 0x8DBD;
GL_COMPRESSED_SIGNED_RG_RGTC2: [const] int32     = 0x8DBE;
GL_RG: [const] int32                             = 0x8227;
GL_RG_INTEGER: [const] int32                     = 0x8228;
GL_R8: [const] int32                             = 0x8229;
GL_R16: [const] int32                            = 0x822A;
GL_RG8: [const] int32                            = 0x822B;
GL_RG16: [const] int32                           = 0x822C;
GL_R16F: [const] int32                           = 0x822D;
GL_R32F: [const] int32                           = 0x822E;
GL_RG16F: [const] int32                          = 0x822F;
GL_RG32F: [const] int32                          = 0x8230;
GL_R8I: [const] int32                            = 0x8231;
GL_R8UI: [const] int32                           = 0x8232;
GL_R16I: [const] int32                           = 0x8233;
GL_R16UI: [const] int32                          = 0x8234;
GL_R32I: [const] int32                           = 0x8235;
GL_R32UI: [const] int32                          = 0x8236;
GL_RG8I: [const] int32                           = 0x8237;
GL_RG8UI: [const] int32                          = 0x8238;
GL_RG16I: [const] int32                          = 0x8239;
GL_RG16UI: [const] int32                         = 0x823A;
GL_RG32I: [const] int32                          = 0x823B;
GL_RG32UI: [const] int32                         = 0x823C;
GL_VERTEX_ARRAY_BINDING: [const] int32           = 0x85B5;
...
GL_SAMPLER_2D_RECT: [const] int32                = 0x8B63;
GL_SAMPLER_2D_RECT_SHADOW: [const] int32         = 0x8B64;
GL_SAMPLER_BUFFER: [const] int32                 = 0x8DC2;
GL_INT_SAMPLER_2D_RECT: [const] int32            = 0x8DCD;
GL_INT_SAMPLER_BUFFER: [const] int32             = 0x8DD0;
GL_UNSIGNED_INT_SAMPLER_2D_RECT: [const] int32   = 0x8DD5;
GL_UNSIGNED_INT_SAMPLER_BUFFER: [const] int32    = 0x8DD8;
GL_TEXTURE_BUFFER: [const] int32                 = 0x8C2A;
GL_MAX_TEXTURE_BUFFER_SIZE: [const] int32        = 0x8C2B;
GL_TEXTURE_BINDING_BUFFER: [const] int32         = 0x8C2C;
GL_TEXTURE_BUFFER_DATA_STORE_BINDING: [const] int32 = 0x8C2D;
GL_TEXTURE_RECTANGLE: [const] int32              = 0x84F5;
GL_TEXTURE_BINDING_RECTANGLE: [const] int32      = 0x84F6;
GL_PROXY_TEXTURE_RECTANGLE: [const] int32        = 0x84F7;
GL_MAX_RECTANGLE_TEXTURE_SIZE: [const] int32     = 0x84F8;
GL_R8_SNORM: [const] int32                       = 0x8F94;
GL_RG8_SNORM: [const] int32                      = 0x8F95;
GL_RGB8_SNORM: [const] int32                     = 0x8F96;
GL_RGBA8_SNORM: [const] int32                    = 0x8F97;
GL_R16_SNORM: [const] int32                      = 0x8F98;
GL_RG16_SNORM: [const] int32                     = 0x8F99;
GL_RGB16_SNORM: [const] int32                    = 0x8F9A;
GL_RGBA16_SNORM: [const] int32                   = 0x8F9B;
GL_SIGNED_NORMALIZED: [const] int32              = 0x8F9C;
GL_PRIMITIVE_RESTART: [const] int32              = 0x8F9D;
GL_PRIMITIVE_RESTART_INDEX: [const] int32        = 0x8F9E;
GL_COPY_READ_BUFFER: [const] int32               = 0x8F36;
GL_COPY_WRITE_BUFFER: [const] int32              = 0x8F37;
GL_UNIFORM_BUFFER: [const] int32                 = 0x8A11;
GL_UNIFORM_BUFFER_BINDING: [const] int32         = 0x8A28;
GL_UNIFORM_BUFFER_START: [const] int32           = 0x8A29;
GL_UNIFORM_BUFFER_SIZE: [const] int32            = 0x8A2A;
GL_MAX_VERTEX_UNIFORM_BLOCKS: [const] int32      = 0x8A2B;
GL_MAX_GEOMETRY_UNIFORM_BLOCKS: [const] int32    = 0x8A2C;
GL_MAX_FRAGMENT_UNIFORM_BLOCKS: [const] int32    = 0x8A2D;
GL_MAX_COMBINED_UNIFORM_BLOCKS: [const] int32    = 0x8A2E;
GL_MAX_UNIFORM_BUFFER_BINDINGS: [const] int32    = 0x8A2F;
GL_MAX_UNIFORM_BLOCK_SIZE: [const] int32         = 0x8A30;
GL_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS: [const] int32 = 0x8A31;
GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS: [const] int32 = 0x8A32;
GL_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS: [const] int32 = 0x8A33;
GL_UNIFORM_BUFFER_OFFSET_ALIGNMENT: [const] int32 = 0x8A34;
GL_ACTIVE_UNIFORM_BLOCK_MAX_NAME_LENGTH: [const] int32 = 0x8A35;
GL_ACTIVE_UNIFORM_BLOCKS: [const] int32          = 0x8A36;
GL_UNIFORM_TYPE: [const] int32                   = 0x8A37;
GL_UNIFORM_SIZE: [const] int32                   = 0x8A38;
GL_UNIFORM_NAME_LENGTH: [const] int32            = 0x8A39;
GL_UNIFORM_BLOCK_INDEX: [const] int32            = 0x8A3A;
GL_UNIFORM_OFFSET: [const] int32                 = 0x8A3B;
GL_UNIFORM_ARRAY_STRIDE: [const] int32           = 0x8A3C;
GL_UNIFORM_MATRIX_STRIDE: [const] int32          = 0x8A3D;
GL_UNIFORM_IS_ROW_MAJOR: [const] int32           = 0x8A3E;
GL_UNIFORM_BLOCK_BINDING: [const] int32          = 0x8A3F;
GL_UNIFORM_BLOCK_DATA_SIZE: [const] int32        = 0x8A40;
GL_UNIFORM_BLOCK_NAME_LENGTH: [const] int32      = 0x8A41;
GL_UNIFORM_BLOCK_ACTIVE_UNIFORMS: [const] int32  = 0x8A42;
GL_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES: [const] int32 = 0x8A43;
GL_UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER: [const] int32 = 0x8A44;
GL_UNIFORM_BLOCK_REFERENCED_BY_GEOMETRY_SHADER: [const] int32 = 0x8A45;
GL_UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER: [const] int32 = 0x8A46;
GL_INVALID_INDEX: [const] int32                  = 0xFFFFFFFF;
...
GL_CONTEXT_CORE_PROFILE_BIT: [const] int32       = 0x00000001;
GL_CONTEXT_COMPATIBILITY_PROFILE_BIT: [const] int32 = 0x00000002;
GL_LINES_ADJACENCY: [const] int32                = 0x000A;
GL_LINE_STRIP_ADJACENCY: [const] int32           = 0x000B;
GL_TRIANGLES_ADJACENCY: [const] int32            = 0x000C;
GL_TRIANGLE_STRIP_ADJACENCY: [const] int32       = 0x000D;
GL_PROGRAM_POINT_SIZE: [const] int32             = 0x8642;
GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS: [const] int32 = 0x8C29;
GL_FRAMEBUFFER_ATTACHMENT_LAYERED: [const] int32 = 0x8DA7;
GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS: [const] int32 = 0x8DA8;
GL_GEOMETRY_SHADER: [const] int32                = 0x8DD9;
GL_GEOMETRY_VERTICES_OUT: [const] int32          = 0x8916;
GL_GEOMETRY_INPUT_TYPE: [const] int32            = 0x8917;
GL_GEOMETRY_OUTPUT_TYPE: [const] int32           = 0x8918;
GL_MAX_GEOMETRY_UNIFORM_COMPONENTS: [const] int32 = 0x8DDF;
GL_MAX_GEOMETRY_OUTPUT_VERTICES: [const] int32   = 0x8DE0;
GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS: [const] int32 = 0x8DE1;
GL_MAX_VERTEX_OUTPUT_COMPONENTS: [const] int32   = 0x9122;
GL_MAX_GEOMETRY_INPUT_COMPONENTS: [const] int32  = 0x9123;
GL_MAX_GEOMETRY_OUTPUT_COMPONENTS: [const] int32 = 0x9124;
GL_MAX_FRAGMENT_INPUT_COMPONENTS: [const] int32  = 0x9125;
GL_CONTEXT_PROFILE_MASK: [const] int32           = 0x9126;
GL_DEPTH_CLAMP: [const] int32                    = 0x864F;
GL_QUADS_FOLLOW_PROVOKING_VERTEX_CONVENTION: [const] int32 = 0x8E4C;
GL_FIRST_VERTEX_CONVENTION: [const] int32        = 0x8E4D;
GL_LAST_VERTEX_CONVENTION: [const] int32         = 0x8E4E;
GL_PROVOKING_VERTEX: [const] int32               = 0x8E4F;
GL_TEXTURE_CUBE_MAP_SEAMLESS: [const] int32      = 0x884F;
GL_MAX_SERVER_WAIT_TIMEOUT: [const] int32        = 0x9111;
GL_OBJECT_TYPE: [const] int32                    = 0x9112;
GL_SYNC_CONDITION: [const] int32                 = 0x9113;
GL_SYNC_STATUS: [const] int32                    = 0x9114;
GL_SYNC_FLAGS: [const] int32                     = 0x9115;
GL_SYNC_FENCE: [const] int32                     = 0x9116;
GL_SYNC_GPU_COMMANDS_COMPLETE: [const] int32     = 0x9117;
GL_UNSIGNALED: [const] int32                     = 0x9118;
GL_SIGNALED: [const] int32                       = 0x9119;
GL_ALREADY_SIGNALED: [const] int32               = 0x911A;
GL_TIMEOUT_EXPIRED: [const] int32                = 0x911B;
GL_CONDITION_SATISFIED: [const] int32            = 0x911C;
GL_WAIT_FAILED: [const] int32                    = 0x911D;
GL_TIMEOUT_IGNORED: [const] int64                = 0xFFFFFFFFFFFFFFFF;
GL_SYNC_FLUSH_COMMANDS_BIT: [const] int32        = 0x00000001;
GL_SAMPLE_POSITION: [const] int32                = 0x8E50;
GL_SAMPLE_MASK: [const] int32                    = 0x8E51;
GL_SAMPLE_MASK_VALUE: [const] int32              = 0x8E52;
GL_MAX_SAMPLE_MASK_WORDS: [const] int32          = 0x8E59;
GL_TEXTURE_2D_MULTISAMPLE: [const] int32         = 0x9100;
GL_PROXY_TEXTURE_2D_MULTISAMPLE: [const] int32   = 0x9101;
GL_TEXTURE_2D_MULTISAMPLE_ARRAY: [const] int32   = 0x9102;
GL_PROXY_TEXTURE_2D_MULTISAMPLE_ARRAY: [const] int32 = 0x9103;
GL_TEXTURE_BINDING_2D_MULTISAMPLE: [const] int32 = 0x9104;
GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY: [const] int32 = 0x9105;
GL_TEXTURE_SAMPLES: [const] int32                = 0x9106;
GL_TEXTURE_FIXED_SAMPLE_LOCATIONS: [const] int32 = 0x9107;
GL_SAMPLER_2D_MULTISAMPLE: [const] int32         = 0x9108;
GL_INT_SAMPLER_2D_MULTISAMPLE: [const] int32     = 0x9109;
GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE: [const] int32 = 0x910A;
GL_SAMPLER_2D_MULTISAMPLE_ARRAY: [const] int32   = 0x910B;
GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: [const] int32 = 0x910C;
GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: [const] int32 = 0x910D;
GL_MAX_COLOR_TEXTURE_SAMPLES: [const] int32      = 0x910E;
GL_MAX_DEPTH_TEXTURE_SAMPLES: [const] int32      = 0x910F;
GL_MAX_INTEGER_SAMPLES: [const] int32            = 0x9110;
...
GL_VERTEX_ATTRIB_ARRAY_DIVISOR: [const] int32    = 0x88FE;
GL_SRC1_COLOR: [const] int32                     = 0x88F9;
GL_ONE_MINUS_SRC1_COLOR: [const] int32           = 0x88FA;
GL_ONE_MINUS_SRC1_ALPHA: [const] int32           = 0x88FB;
GL_MAX_DUAL_SOURCE_DRAW_BUFFERS: [const] int32   = 0x88FC;
GL_ANY_SAMPLES_PASSED: [const] int32             = 0x8C2F;
GL_SAMPLER_BINDING: [const] int32                = 0x8919;
GL_RGB10_A2UI: [const] int32                     = 0x906F;
GL_TEXTURE_SWIZZLE_R: [const] int32              = 0x8E42;
GL_TEXTURE_SWIZZLE_G: [const] int32              = 0x8E43;
GL_TEXTURE_SWIZZLE_B: [const] int32              = 0x8E44;
GL_TEXTURE_SWIZZLE_A: [const] int32              = 0x8E45;
GL_TEXTURE_SWIZZLE_RGBA: [const] int32           = 0x8E46;
GL_TIME_ELAPSED: [const] int32                   = 0x88BF;
GL_TIMESTAMP: [const] int32                      = 0x8E28;
GL_INT_2_10_10_10_REV: [const] int32             = 0x8D9F;
...
GL_SAMPLE_SHADING: [const] int32                 = 0x8C36;
GL_MIN_SAMPLE_SHADING_VALUE: [const] int32       = 0x8C37;
GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET: [const] int32 = 0x8E5E;
GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET: [const] int32 = 0x8E5F;
GL_TEXTURE_CUBE_MAP_ARRAY: [const] int32         = 0x9009;
GL_TEXTURE_BINDING_CUBE_MAP_ARRAY: [const] int32 = 0x900A;
GL_PROXY_TEXTURE_CUBE_MAP_ARRAY: [const] int32   = 0x900B;
GL_SAMPLER_CUBE_MAP_ARRAY: [const] int32         = 0x900C;
GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW: [const] int32  = 0x900D;
GL_INT_SAMPLER_CUBE_MAP_ARRAY: [const] int32     = 0x900E;
GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY: [const] int32 = 0x900F;
GL_DRAW_INDIRECT_BUFFER: [const] int32           = 0x8F3F;
GL_DRAW_INDIRECT_BUFFER_BINDING: [const] int32   = 0x8F43;
GL_GEOMETRY_SHADER_INVOCATIONS: [const] int32    = 0x887F;
GL_MAX_GEOMETRY_SHADER_INVOCATIONS: [const] int32 = 0x8E5A;
GL_MIN_FRAGMENT_INTERPOLATION_OFFSET: [const] int32 = 0x8E5B;
GL_MAX_FRAGMENT_INTERPOLATION_OFFSET: [const] int32 = 0x8E5C;
GL_FRAGMENT_INTERPOLATION_OFFSET_BITS: [const] int32 = 0x8E5D;
GL_MAX_VERTEX_STREAMS: [const] int32             = 0x8E71;
GL_DOUBLE_VEC2: [const] int32                    = 0x8FFC;
GL_DOUBLE_VEC3: [const] int32                    = 0x8FFD;
GL_DOUBLE_VEC4: [const] int32                    = 0x8FFE;
GL_DOUBLE_MAT2: [const] int32                    = 0x8F46;
GL_DOUBLE_MAT3: [const] int32                    = 0x8F47;
GL_DOUBLE_MAT4: [const] int32                    = 0x8F48;
GL_DOUBLE_MAT2x3: [const] int32                  = 0x8F49;
GL_DOUBLE_MAT2x4: [const] int32                  = 0x8F4A;
GL_DOUBLE_MAT3x2: [const] int32                  = 0x8F4B;
GL_DOUBLE_MAT3x4: [const] int32                  = 0x8F4C;
GL_DOUBLE_MAT4x2: [const] int32                  = 0x8F4D;
GL_DOUBLE_MAT4x3: [const] int32                  = 0x8F4E;
GL_ACTIVE_SUBROUTINES: [const] int32             = 0x8DE5;
GL_ACTIVE_SUBROUTINE_UNIFORMS: [const] int32     = 0x8DE6;
GL_ACTIVE_SUBROUTINE_UNIFORM_LOCATIONS: [const] int32 = 0x8E47;
GL_ACTIVE_SUBROUTINE_MAX_LENGTH: [const] int32   = 0x8E48;
GL_ACTIVE_SUBROUTINE_UNIFORM_MAX_LENGTH: [const] int32 = 0x8E49;
GL_MAX_SUBROUTINES: [const] int32                = 0x8DE7;
GL_MAX_SUBROUTINE_UNIFORM_LOCATIONS: [const] int32 = 0x8DE8;
GL_NUM_COMPATIBLE_SUBROUTINES: [const] int32     = 0x8E4A;
GL_COMPATIBLE_SUBROUTINES: [const] int32         = 0x8E4B;
GL_PATCHES: [const] int32                        = 0x000E;
GL_PATCH_VERTICES: [const] int32                 = 0x8E72;
GL_PATCH_DEFAULT_INNER_LEVEL: [const] int32      = 0x8E73;
GL_PATCH_DEFAULT_OUTER_LEVEL: [const] int32      = 0x8E74;
GL_TESS_CONTROL_OUTPUT_VERTICES: [const] int32   = 0x8E75;
GL_TESS_GEN_MODE: [const] int32                  = 0x8E76;
GL_TESS_GEN_SPACING: [const] int32               = 0x8E77;
GL_TESS_GEN_VERTEX_ORDER: [const] int32          = 0x8E78;
GL_TESS_GEN_POINT_MODE: [const] int32            = 0x8E79;
GL_ISOLINES: [const] int32                       = 0x8E7A;
GL_FRACTIONAL_ODD: [const] int32                 = 0x8E7B;
GL_FRACTIONAL_EVEN: [const] int32                = 0x8E7C;
GL_MAX_PATCH_VERTICES: [const] int32             = 0x8E7D;
GL_MAX_TESS_GEN_LEVEL: [const] int32             = 0x8E7E;
GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS: [const] int32 = 0x8E7F;
GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS: [const] int32 = 0x8E80;
GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS: [const] int32 = 0x8E81;
GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS: [const] int32 = 0x8E82;
GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS: [const] int32 = 0x8E83;
GL_MAX_TESS_PATCH_COMPONENTS: [const] int32      = 0x8E84;
GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS: [const] int32 = 0x8E85;
GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS: [const] int32 = 0x8E86;
GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS: [const] int32 = 0x8E89;
GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS: [const] int32 = 0x8E8A;
GL_MAX_TESS_CONTROL_INPUT_COMPONENTS: [const] int32 = 0x886C;
GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS: [const] int32 = 0x886D;
GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS: [const] int32 = 0x8E1E;
GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS: [const] int32 = 0x8E1F;
GL_UNIFORM_BLOCK_REFERENCED_BY_TESS_CONTROL_SHADER: [const] int32 = 0x84F0;
GL_UNIFORM_BLOCK_REFERENCED_BY_TESS_EVALUATION_SHADER: [const] int32 = 0x84F1;
GL_TESS_EVALUATION_SHADER: [const] int32         = 0x8E87;
GL_TESS_CONTROL_SHADER: [const] int32            = 0x8E88;
GL_TRANSFORM_FEEDBACK: [const] int32             = 0x8E22;
GL_TRANSFORM_FEEDBACK_BUFFER_PAUSED: [const] int32 = 0x8E23;
GL_TRANSFORM_FEEDBACK_BUFFER_ACTIVE: [const] int32 = 0x8E24;
GL_TRANSFORM_FEEDBACK_BINDING: [const] int32     = 0x8E25;
GL_MAX_TRANSFORM_FEEDBACK_BUFFERS: [const] int32 = 0x8E70;
...
GL_FIXED: [const] int32                          = 0x140C;
GL_IMPLEMENTATION_COLOR_READ_TYPE: [const] int32 = 0x8B9A;
GL_IMPLEMENTATION_COLOR_READ_FORMAT: [const] int32 = 0x8B9B;
GL_LOW_FLOAT: [const] int32                      = 0x8DF0;
GL_MEDIUM_FLOAT: [const] int32                   = 0x8DF1;
GL_HIGH_FLOAT: [const] int32                     = 0x8DF2;
GL_LOW_INT: [const] int32                        = 0x8DF3;
GL_MEDIUM_INT: [const] int32                     = 0x8DF4;
GL_HIGH_INT: [const] int32                       = 0x8DF5;
GL_SHADER_COMPILER: [const] int32                = 0x8DFA;
GL_SHADER_BINARY_FORMATS: [const] int32          = 0x8DF8;
GL_NUM_SHADER_BINARY_FORMATS: [const] int32      = 0x8DF9;
GL_MAX_VERTEX_UNIFORM_VECTORS: [const] int32     = 0x8DFB;
GL_MAX_VARYING_VECTORS: [const] int32            = 0x8DFC;
GL_MAX_FRAGMENT_UNIFORM_VECTORS: [const] int32   = 0x8DFD;
GL_RGB565: [const] int32                         = 0x8D62;
GL_PROGRAM_BINARY_RETRIEVABLE_HINT: [const] int32 = 0x8257;
GL_PROGRAM_BINARY_LENGTH: [const] int32          = 0x8741;
GL_NUM_PROGRAM_BINARY_FORMATS: [const] int32     = 0x87FE;
GL_PROGRAM_BINARY_FORMATS: [const] int32         = 0x87FF;
GL_VERTEX_SHADER_BIT: [const] int32              = 0x00000001;
GL_FRAGMENT_SHADER_BIT: [const] int32            = 0x00000002;
GL_GEOMETRY_SHADER_BIT: [const] int32            = 0x00000004;
GL_TESS_CONTROL_SHADER_BIT: [const] int32        = 0x00000008;
GL_TESS_EVALUATION_SHADER_BIT: [const] int32     = 0x00000010;
GL_ALL_SHADER_BITS: [const] int32                = 0xFFFFFFFF;
GL_PROGRAM_SEPARABLE: [const] int32              = 0x8258;
GL_ACTIVE_PROGRAM: [const] int32                 = 0x8259;
GL_PROGRAM_PIPELINE_BINDING: [const] int32       = 0x825A;
GL_MAX_VIEWPORTS: [const] int32                  = 0x825B;
GL_VIEWPORT_SUBPIXEL_BITS: [const] int32         = 0x825C;
GL_VIEWPORT_BOUNDS_RANGE: [const] int32          = 0x825D;
GL_LAYER_PROVOKING_VERTEX: [const] int32         = 0x825E;
GL_VIEWPORT_INDEX_PROVOKING_VERTEX: [const] int32 = 0x825F;
GL_UNDEFINED_VERTEX: [const] int32               = 0x8260;
...
GL_COPY_READ_BUFFER_BINDING: [const] int32       = 0x8F36;
GL_COPY_WRITE_BUFFER_BINDING: [const] int32      = 0x8F37;
GL_TRANSFORM_FEEDBACK_ACTIVE: [const] int32      = 0x8E24;
GL_TRANSFORM_FEEDBACK_PAUSED: [const] int32      = 0x8E23;
GL_UNPACK_COMPRESSED_BLOCK_WIDTH: [const] int32  = 0x9127;
GL_UNPACK_COMPRESSED_BLOCK_HEIGHT: [const] int32 = 0x9128;
GL_UNPACK_COMPRESSED_BLOCK_DEPTH: [const] int32  = 0x9129;
GL_UNPACK_COMPRESSED_BLOCK_SIZE: [const] int32   = 0x912A;
GL_PACK_COMPRESSED_BLOCK_WIDTH: [const] int32    = 0x912B;
GL_PACK_COMPRESSED_BLOCK_HEIGHT: [const] int32   = 0x912C;
GL_PACK_COMPRESSED_BLOCK_DEPTH: [const] int32    = 0x912D;
GL_PACK_COMPRESSED_BLOCK_SIZE: [const] int32     = 0x912E;
GL_NUM_SAMPLE_COUNTS: [const] int32              = 0x9380;
GL_MIN_MAP_BUFFER_ALIGNMENT: [const] int32       = 0x90BC;
GL_ATOMIC_COUNTER_BUFFER: [const] int32          = 0x92C0;
GL_ATOMIC_COUNTER_BUFFER_BINDING: [const] int32  = 0x92C1;
GL_ATOMIC_COUNTER_BUFFER_START: [const] int32    = 0x92C2;
GL_ATOMIC_COUNTER_BUFFER_SIZE: [const] int32     = 0x92C3;
GL_ATOMIC_COUNTER_BUFFER_DATA_SIZE: [const] int32 = 0x92C4;
GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTERS: [const] int32 = 0x92C5;
GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES: [const] int32 = 0x92C6;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_VERTEX_SHADER: [const] int32 = 0x92C7;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_CONTROL_SHADER: [const] int32 = 0x92C8;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER: [const] int32 = 0x92C9;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_GEOMETRY_SHADER: [const] int32 = 0x92CA;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_FRAGMENT_SHADER: [const] int32 = 0x92CB;
GL_MAX_VERTEX_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x92CC;
GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x92CD;
GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x92CE;
GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x92CF;
GL_MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x92D0;
GL_MAX_COMBINED_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x92D1;
GL_MAX_VERTEX_ATOMIC_COUNTERS: [const] int32     = 0x92D2;
GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS: [const] int32 = 0x92D3;
GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS: [const] int32 = 0x92D4;
GL_MAX_GEOMETRY_ATOMIC_COUNTERS: [const] int32   = 0x92D5;
GL_MAX_FRAGMENT_ATOMIC_COUNTERS: [const] int32   = 0x92D6;
GL_MAX_COMBINED_ATOMIC_COUNTERS: [const] int32   = 0x92D7;
GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE: [const] int32 = 0x92D8;
GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS: [const] int32 = 0x92DC;
GL_ACTIVE_ATOMIC_COUNTER_BUFFERS: [const] int32  = 0x92D9;
GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX: [const] int32 = 0x92DA;
GL_UNSIGNED_INT_ATOMIC_COUNTER: [const] int32    = 0x92DB;
GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT: [const] int32 = 0x00000001;
GL_ELEMENT_ARRAY_BARRIER_BIT: [const] int32      = 0x00000002;
GL_UNIFORM_BARRIER_BIT: [const] int32            = 0x00000004;
GL_TEXTURE_FETCH_BARRIER_BIT: [const] int32      = 0x00000008;
GL_SHADER_IMAGE_ACCESS_BARRIER_BIT: [const] int32 = 0x00000020;
GL_COMMAND_BARRIER_BIT: [const] int32            = 0x00000040;
GL_PIXEL_BUFFER_BARRIER_BIT: [const] int32       = 0x00000080;
GL_TEXTURE_UPDATE_BARRIER_BIT: [const] int32     = 0x00000100;
GL_BUFFER_UPDATE_BARRIER_BIT: [const] int32      = 0x00000200;
GL_FRAMEBUFFER_BARRIER_BIT: [const] int32        = 0x00000400;
GL_TRANSFORM_FEEDBACK_BARRIER_BIT: [const] int32 = 0x00000800;
GL_ATOMIC_COUNTER_BARRIER_BIT: [const] int32     = 0x00001000;
GL_ALL_BARRIER_BITS: [const] int32               = 0xFFFFFFFF;
GL_MAX_IMAGE_UNITS: [const] int32                = 0x8F38;
GL_MAX_COMBINED_IMAGE_UNITS_AND_FRAGMENT_OUTPUTS: [const] int32 = 0x8F39;
GL_IMAGE_BINDING_NAME: [const] int32             = 0x8F3A;
GL_IMAGE_BINDING_LEVEL: [const] int32            = 0x8F3B;
GL_IMAGE_BINDING_LAYERED: [const] int32          = 0x8F3C;
GL_IMAGE_BINDING_LAYER: [const] int32            = 0x8F3D;
GL_IMAGE_BINDING_ACCESS: [const] int32           = 0x8F3E;
GL_IMAGE_1D: [const] int32                       = 0x904C;
GL_IMAGE_2D: [const] int32                       = 0x904D;
GL_IMAGE_3D: [const] int32                       = 0x904E;
GL_IMAGE_2D_RECT: [const] int32                  = 0x904F;
GL_IMAGE_CUBE: [const] int32                     = 0x9050;
GL_IMAGE_BUFFER: [const] int32                   = 0x9051;
GL_IMAGE_1D_ARRAY: [const] int32                 = 0x9052;
GL_IMAGE_2D_ARRAY: [const] int32                 = 0x9053;
GL_IMAGE_CUBE_MAP_ARRAY: [const] int32           = 0x9054;
GL_IMAGE_2D_MULTISAMPLE: [const] int32           = 0x9055;
GL_IMAGE_2D_MULTISAMPLE_ARRAY: [const] int32     = 0x9056;
GL_INT_IMAGE_1D: [const] int32                   = 0x9057;
GL_INT_IMAGE_2D: [const] int32                   = 0x9058;
GL_INT_IMAGE_3D: [const] int32                   = 0x9059;
GL_INT_IMAGE_2D_RECT: [const] int32              = 0x905A;
GL_INT_IMAGE_CUBE: [const] int32                 = 0x905B;
GL_INT_IMAGE_BUFFER: [const] int32               = 0x905C;
GL_INT_IMAGE_1D_ARRAY: [const] int32             = 0x905D;
GL_INT_IMAGE_2D_ARRAY: [const] int32             = 0x905E;
GL_INT_IMAGE_CUBE_MAP_ARRAY: [const] int32       = 0x905F;
GL_INT_IMAGE_2D_MULTISAMPLE: [const] int32       = 0x9060;
GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY: [const] int32 = 0x9061;
GL_UNSIGNED_INT_IMAGE_1D: [const] int32          = 0x9062;
GL_UNSIGNED_INT_IMAGE_2D: [const] int32          = 0x9063;
GL_UNSIGNED_INT_IMAGE_3D: [const] int32          = 0x9064;
GL_UNSIGNED_INT_IMAGE_2D_RECT: [const] int32     = 0x9065;
GL_UNSIGNED_INT_IMAGE_CUBE: [const] int32        = 0x9066;
GL_UNSIGNED_INT_IMAGE_BUFFER: [const] int32      = 0x9067;
GL_UNSIGNED_INT_IMAGE_1D_ARRAY: [const] int32    = 0x9068;
GL_UNSIGNED_INT_IMAGE_2D_ARRAY: [const] int32    = 0x9069;
GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY: [const] int32 = 0x906A;
GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE: [const] int32 = 0x906B;
GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY: [const] int32 = 0x906C;
GL_MAX_IMAGE_SAMPLES: [const] int32              = 0x906D;
GL_IMAGE_BINDING_FORMAT: [const] int32           = 0x906E;
GL_IMAGE_FORMAT_COMPATIBILITY_TYPE: [const] int32 = 0x90C7;
GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE: [const] int32 = 0x90C8;
GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS: [const] int32 = 0x90C9;
GL_MAX_VERTEX_IMAGE_UNIFORMS: [const] int32      = 0x90CA;
GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS: [const] int32 = 0x90CB;
GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS: [const] int32 = 0x90CC;
GL_MAX_GEOMETRY_IMAGE_UNIFORMS: [const] int32    = 0x90CD;
GL_MAX_FRAGMENT_IMAGE_UNIFORMS: [const] int32    = 0x90CE;
GL_MAX_COMBINED_IMAGE_UNIFORMS: [const] int32    = 0x90CF;
GL_COMPRESSED_RGBA_BPTC_UNORM: [const] int32     = 0x8E8C;
GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM: [const] int32 = 0x8E8D;
GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT: [const] int32 = 0x8E8E;
GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT: [const] int32 = 0x8E8F;
GL_TEXTURE_IMMUTABLE_FORMAT: [const] int32       = 0x912F;
...
GL_NUM_SHADING_LANGUAGE_VERSIONS: [const] int32  = 0x82E9;
GL_VERTEX_ATTRIB_ARRAY_LONG: [const] int32       = 0x874E;
GL_COMPRESSED_RGB8_ETC2: [const] int32           = 0x9274;
GL_COMPRESSED_SRGB8_ETC2: [const] int32          = 0x9275;
GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2: [const] int32 = 0x9276;
GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2: [const] int32 = 0x9277;
GL_COMPRESSED_RGBA8_ETC2_EAC: [const] int32      = 0x9278;
GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC: [const] int32 = 0x9279;
GL_COMPRESSED_R11_EAC: [const] int32             = 0x9270;
GL_COMPRESSED_SIGNED_R11_EAC: [const] int32      = 0x9271;
GL_COMPRESSED_RG11_EAC: [const] int32            = 0x9272;
GL_COMPRESSED_SIGNED_RG11_EAC: [const] int32     = 0x9273;
GL_PRIMITIVE_RESTART_FIXED_INDEX: [const] int32  = 0x8D69;
GL_ANY_SAMPLES_PASSED_CONSERVATIVE: [const] int32 = 0x8D6A;
GL_MAX_ELEMENT_INDEX: [const] int32              = 0x8D6B;
GL_COMPUTE_SHADER: [const] int32                 = 0x91B9;
GL_MAX_COMPUTE_UNIFORM_BLOCKS: [const] int32     = 0x91BB;
GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS: [const] int32 = 0x91BC;
GL_MAX_COMPUTE_IMAGE_UNIFORMS: [const] int32     = 0x91BD;
GL_MAX_COMPUTE_SHARED_MEMORY_SIZE: [const] int32 = 0x8262;
GL_MAX_COMPUTE_UNIFORM_COMPONENTS: [const] int32 = 0x8263;
GL_MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS: [const] int32 = 0x8264;
GL_MAX_COMPUTE_ATOMIC_COUNTERS: [const] int32    = 0x8265;
GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS: [const] int32 = 0x8266;
GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS: [const] int32 = 0x90EB;
GL_MAX_COMPUTE_WORK_GROUP_COUNT: [const] int32   = 0x91BE;
GL_MAX_COMPUTE_WORK_GROUP_SIZE: [const] int32    = 0x91BF;
GL_COMPUTE_WORK_GROUP_SIZE: [const] int32        = 0x8267;
GL_UNIFORM_BLOCK_REFERENCED_BY_COMPUTE_SHADER: [const] int32 = 0x90EC;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_COMPUTE_SHADER: [const] int32 = 0x90ED;
GL_DISPATCH_INDIRECT_BUFFER: [const] int32       = 0x90EE;
GL_DISPATCH_INDIRECT_BUFFER_BINDING: [const] int32 = 0x90EF;
GL_COMPUTE_SHADER_BIT: [const] int32             = 0x00000020;
GL_DEBUG_OUTPUT_SYNCHRONOUS: [const] int32       = 0x8242;
GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH: [const] int32 = 0x8243;
GL_DEBUG_CALLBACK_FUNCTION: [const] int32        = 0x8244;
GL_DEBUG_CALLBACK_USER_PARAM: [const] int32      = 0x8245;
GL_DEBUG_SOURCE_API: [const] int32               = 0x8246;
GL_DEBUG_SOURCE_WINDOW_SYSTEM: [const] int32     = 0x8247;
GL_DEBUG_SOURCE_SHADER_COMPILER: [const] int32   = 0x8248;
GL_DEBUG_SOURCE_THIRD_PARTY: [const] int32       = 0x8249;
GL_DEBUG_SOURCE_APPLICATION: [const] int32       = 0x824A;
GL_DEBUG_SOURCE_OTHER: [const] int32             = 0x824B;
GL_DEBUG_TYPE_ERROR: [const] int32               = 0x824C;
GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR: [const] int32 = 0x824D;
GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR: [const] int32  = 0x824E;
GL_DEBUG_TYPE_PORTABILITY: [const] int32         = 0x824F;
GL_DEBUG_TYPE_PERFORMANCE: [const] int32         = 0x8250;
GL_DEBUG_TYPE_OTHER: [const] int32               = 0x8251;
GL_MAX_DEBUG_MESSAGE_LENGTH: [const] int32       = 0x9143;
GL_MAX_DEBUG_LOGGED_MESSAGES: [const] int32      = 0x9144;
GL_DEBUG_LOGGED_MESSAGES: [const] int32          = 0x9145;
GL_DEBUG_SEVERITY_HIGH: [const] int32            = 0x9146;
GL_DEBUG_SEVERITY_MEDIUM: [const] int32          = 0x9147;
GL_DEBUG_SEVERITY_LOW: [const] int32             = 0x9148;
GL_DEBUG_TYPE_MARKER: [const] int32              = 0x8268;
GL_DEBUG_TYPE_PUSH_GROUP: [const] int32          = 0x8269;
GL_DEBUG_TYPE_POP_GROUP: [const] int32           = 0x826A;
GL_DEBUG_SEVERITY_NOTIFICATION: [const] int32    = 0x826B;
GL_MAX_DEBUG_GROUP_STACK_DEPTH: [const] int32    = 0x826C;
GL_DEBUG_GROUP_STACK_DEPTH: [const] int32        = 0x826D;
GL_BUFFER: [const] int32                         = 0x82E0;
GL_SHADER: [const] int32                         = 0x82E1;
GL_PROGRAM: [const] int32                        = 0x82E2;
GL_QUERY: [const] int32                          = 0x82E3;
GL_PROGRAM_PIPELINE: [const] int32               = 0x82E4;
GL_SAMPLER: [const] int32                        = 0x82E6;
GL_MAX_LABEL_LENGTH: [const] int32               = 0x82E8;
GL_DEBUG_OUTPUT: [const] int32                   = 0x92E0;
GL_CONTEXT_FLAG_DEBUG_BIT: [const] int32         = 0x00000002;
GL_MAX_UNIFORM_LOCATIONS: [const] int32          = 0x826E;
GL_FRAMEBUFFER_DEFAULT_WIDTH: [const] int32      = 0x9310;
GL_FRAMEBUFFER_DEFAULT_HEIGHT: [const] int32     = 0x9311;
GL_FRAMEBUFFER_DEFAULT_LAYERS: [const] int32     = 0x9312;
GL_FRAMEBUFFER_DEFAULT_SAMPLES: [const] int32    = 0x9313;
GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS: [const] int32 = 0x9314;
GL_MAX_FRAMEBUFFER_WIDTH: [const] int32          = 0x9315;
GL_MAX_FRAMEBUFFER_HEIGHT: [const] int32         = 0x9316;
GL_MAX_FRAMEBUFFER_LAYERS: [const] int32         = 0x9317;
GL_MAX_FRAMEBUFFER_SAMPLES: [const] int32        = 0x9318;
GL_INTERNALFORMAT_SUPPORTED: [const] int32       = 0x826F;
GL_INTERNALFORMAT_PREFERRED: [const] int32       = 0x8270;
GL_INTERNALFORMAT_RED_SIZE: [const] int32        = 0x8271;
GL_INTERNALFORMAT_GREEN_SIZE: [const] int32      = 0x8272;
GL_INTERNALFORMAT_BLUE_SIZE: [const] int32       = 0x8273;
GL_INTERNALFORMAT_ALPHA_SIZE: [const] int32      = 0x8274;
GL_INTERNALFORMAT_DEPTH_SIZE: [const] int32      = 0x8275;
GL_INTERNALFORMAT_STENCIL_SIZE: [const] int32    = 0x8276;
GL_INTERNALFORMAT_SHARED_SIZE: [const] int32     = 0x8277;
GL_INTERNALFORMAT_RED_TYPE: [const] int32        = 0x8278;
GL_INTERNALFORMAT_GREEN_TYPE: [const] int32      = 0x8279;
GL_INTERNALFORMAT_BLUE_TYPE: [const] int32       = 0x827A;
GL_INTERNALFORMAT_ALPHA_TYPE: [const] int32      = 0x827B;
GL_INTERNALFORMAT_DEPTH_TYPE: [const] int32      = 0x827C;
GL_INTERNALFORMAT_STENCIL_TYPE: [const] int32    = 0x827D;
GL_MAX_WIDTH: [const] int32                      = 0x827E;
GL_MAX_HEIGHT: [const] int32                     = 0x827F;
GL_MAX_DEPTH: [const] int32                      = 0x8280;
GL_MAX_LAYERS: [const] int32                     = 0x8281;
GL_MAX_COMBINED_DIMENSIONS: [const] int32        = 0x8282;
GL_COLOR_COMPONENTS: [const] int32               = 0x8283;
GL_DEPTH_COMPONENTS: [const] int32               = 0x8284;
GL_STENCIL_COMPONENTS: [const] int32             = 0x8285;
GL_COLOR_RENDERABLE: [const] int32               = 0x8286;
GL_DEPTH_RENDERABLE: [const] int32               = 0x8287;
GL_STENCIL_RENDERABLE: [const] int32             = 0x8288;
GL_FRAMEBUFFER_RENDERABLE: [const] int32         = 0x8289;
GL_FRAMEBUFFER_RENDERABLE_LAYERED: [const] int32 = 0x828A;
GL_FRAMEBUFFER_BLEND: [const] int32              = 0x828B;
GL_READ_PIXELS: [const] int32                    = 0x828C;
GL_READ_PIXELS_FORMAT: [const] int32             = 0x828D;
GL_READ_PIXELS_TYPE: [const] int32               = 0x828E;
GL_TEXTURE_IMAGE_FORMAT: [const] int32           = 0x828F;
GL_TEXTURE_IMAGE_TYPE: [const] int32             = 0x8290;
GL_GET_TEXTURE_IMAGE_FORMAT: [const] int32       = 0x8291;
GL_GET_TEXTURE_IMAGE_TYPE: [const] int32         = 0x8292;
GL_MIPMAP: [const] int32                         = 0x8293;
GL_MANUAL_GENERATE_MIPMAP: [const] int32         = 0x8294;
GL_AUTO_GENERATE_MIPMAP: [const] int32           = 0x8295;
GL_COLOR_ENCODING: [const] int32                 = 0x8296;
GL_SRGB_READ: [const] int32                      = 0x8297;
GL_SRGB_WRITE: [const] int32                     = 0x8298;
GL_FILTER: [const] int32                         = 0x829A;
GL_VERTEX_TEXTURE: [const] int32                 = 0x829B;
GL_TESS_CONTROL_TEXTURE: [const] int32           = 0x829C;
GL_TESS_EVALUATION_TEXTURE: [const] int32        = 0x829D;
GL_GEOMETRY_TEXTURE: [const] int32               = 0x829E;
GL_FRAGMENT_TEXTURE: [const] int32               = 0x829F;
GL_COMPUTE_TEXTURE: [const] int32                = 0x82A0;
GL_TEXTURE_SHADOW: [const] int32                 = 0x82A1;
GL_TEXTURE_GATHER: [const] int32                 = 0x82A2;
GL_TEXTURE_GATHER_SHADOW: [const] int32          = 0x82A3;
GL_SHADER_IMAGE_LOAD: [const] int32              = 0x82A4;
GL_SHADER_IMAGE_STORE: [const] int32             = 0x82A5;
GL_SHADER_IMAGE_ATOMIC: [const] int32            = 0x82A6;
GL_IMAGE_TEXEL_SIZE: [const] int32               = 0x82A7;
GL_IMAGE_COMPATIBILITY_CLASS: [const] int32      = 0x82A8;
GL_IMAGE_PIXEL_FORMAT: [const] int32             = 0x82A9;
GL_IMAGE_PIXEL_TYPE: [const] int32               = 0x82AA;
GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST: [const] int32 = 0x82AC;
GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST: [const] int32 = 0x82AD;
GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WRITE: [const] int32 = 0x82AE;
GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE: [const] int32 = 0x82AF;
GL_TEXTURE_COMPRESSED_BLOCK_WIDTH: [const] int32 = 0x82B1;
GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT: [const] int32 = 0x82B2;
GL_TEXTURE_COMPRESSED_BLOCK_SIZE: [const] int32  = 0x82B3;
GL_CLEAR_BUFFER: [const] int32                   = 0x82B4;
GL_TEXTURE_VIEW: [const] int32                   = 0x82B5;
GL_VIEW_COMPATIBILITY_CLASS: [const] int32       = 0x82B6;
GL_FULL_SUPPORT: [const] int32                   = 0x82B7;
GL_CAVEAT_SUPPORT: [const] int32                 = 0x82B8;
GL_IMAGE_CLASS_4_X_32: [const] int32             = 0x82B9;
GL_IMAGE_CLASS_2_X_32: [const] int32             = 0x82BA;
GL_IMAGE_CLASS_1_X_32: [const] int32             = 0x82BB;
GL_IMAGE_CLASS_4_X_16: [const] int32             = 0x82BC;
GL_IMAGE_CLASS_2_X_16: [const] int32             = 0x82BD;
GL_IMAGE_CLASS_1_X_16: [const] int32             = 0x82BE;
GL_IMAGE_CLASS_4_X_8: [const] int32              = 0x82BF;
GL_IMAGE_CLASS_2_X_8: [const] int32              = 0x82C0;
GL_IMAGE_CLASS_1_X_8: [const] int32              = 0x82C1;
GL_IMAGE_CLASS_11_11_10: [const] int32           = 0x82C2;
GL_IMAGE_CLASS_10_10_10_2: [const] int32         = 0x82C3;
GL_VIEW_CLASS_128_BITS: [const] int32            = 0x82C4;
GL_VIEW_CLASS_96_BITS: [const] int32             = 0x82C5;
GL_VIEW_CLASS_64_BITS: [const] int32             = 0x82C6;
GL_VIEW_CLASS_48_BITS: [const] int32             = 0x82C7;
GL_VIEW_CLASS_32_BITS: [const] int32             = 0x82C8;
GL_VIEW_CLASS_24_BITS: [const] int32             = 0x82C9;
GL_VIEW_CLASS_16_BITS: [const] int32             = 0x82CA;
GL_VIEW_CLASS_8_BITS: [const] int32              = 0x82CB;
GL_VIEW_CLASS_S3TC_DXT1_RGB: [const] int32       = 0x82CC;
GL_VIEW_CLASS_S3TC_DXT1_RGBA: [const] int32      = 0x82CD;
GL_VIEW_CLASS_S3TC_DXT3_RGBA: [const] int32      = 0x82CE;
GL_VIEW_CLASS_S3TC_DXT5_RGBA: [const] int32      = 0x82CF;
GL_VIEW_CLASS_RGTC1_RED: [const] int32           = 0x82D0;
GL_VIEW_CLASS_RGTC2_RG: [const] int32            = 0x82D1;
GL_VIEW_CLASS_BPTC_UNORM: [const] int32          = 0x82D2;
GL_VIEW_CLASS_BPTC_FLOAT: [const] int32          = 0x82D3;
GL_UNIFORM: [const] int32                        = 0x92E1;
GL_UNIFORM_BLOCK: [const] int32                  = 0x92E2;
GL_PROGRAM_INPUT: [const] int32                  = 0x92E3;
GL_PROGRAM_OUTPUT: [const] int32                 = 0x92E4;
GL_BUFFER_VARIABLE: [const] int32                = 0x92E5;
GL_SHADER_STORAGE_BLOCK: [const] int32           = 0x92E6;
GL_VERTEX_SUBROUTINE: [const] int32              = 0x92E8;
GL_TESS_CONTROL_SUBROUTINE: [const] int32        = 0x92E9;
GL_TESS_EVALUATION_SUBROUTINE: [const] int32     = 0x92EA;
GL_GEOMETRY_SUBROUTINE: [const] int32            = 0x92EB;
GL_FRAGMENT_SUBROUTINE: [const] int32            = 0x92EC;
GL_COMPUTE_SUBROUTINE: [const] int32             = 0x92ED;
GL_VERTEX_SUBROUTINE_UNIFORM: [const] int32      = 0x92EE;
GL_TESS_CONTROL_SUBROUTINE_UNIFORM: [const] int32 = 0x92EF;
GL_TESS_EVALUATION_SUBROUTINE_UNIFORM: [const] int32 = 0x92F0;
GL_GEOMETRY_SUBROUTINE_UNIFORM: [const] int32    = 0x92F1;
GL_FRAGMENT_SUBROUTINE_UNIFORM: [const] int32    = 0x92F2;
GL_COMPUTE_SUBROUTINE_UNIFORM: [const] int32     = 0x92F3;
GL_TRANSFORM_FEEDBACK_VARYING: [const] int32     = 0x92F4;
GL_ACTIVE_RESOURCES: [const] int32               = 0x92F5;
GL_MAX_NAME_LENGTH: [const] int32                = 0x92F6;
GL_MAX_NUM_ACTIVE_VARIABLES: [const] int32       = 0x92F7;
GL_MAX_NUM_COMPATIBLE_SUBROUTINES: [const] int32 = 0x92F8;
GL_NAME_LENGTH: [const] int32                    = 0x92F9;
GL_TYPE: [const] int32                           = 0x92FA;
GL_ARRAY_SIZE: [const] int32                     = 0x92FB;
GL_OFFSET: [const] int32                         = 0x92FC;
GL_BLOCK_INDEX: [const] int32                    = 0x92FD;
GL_ARRAY_STRIDE: [const] int32                   = 0x92FE;
GL_MATRIX_STRIDE: [const] int32                  = 0x92FF;
GL_IS_ROW_MAJOR: [const] int32                   = 0x9300;
GL_ATOMIC_COUNTER_BUFFER_INDEX: [const] int32    = 0x9301;
GL_BUFFER_BINDING: [const] int32                 = 0x9302;
GL_BUFFER_DATA_SIZE: [const] int32               = 0x9303;
GL_NUM_ACTIVE_VARIABLES: [const] int32           = 0x9304;
GL_ACTIVE_VARIABLES: [const] int32               = 0x9305;
GL_REFERENCED_BY_VERTEX_SHADER: [const] int32    = 0x9306;
GL_REFERENCED_BY_TESS_CONTROL_SHADER: [const] int32 = 0x9307;
GL_REFERENCED_BY_TESS_EVALUATION_SHADER: [const] int32 = 0x9308;
GL_REFERENCED_BY_GEOMETRY_SHADER: [const] int32  = 0x9309;
GL_REFERENCED_BY_FRAGMENT_SHADER: [const] int32  = 0x930A;
GL_REFERENCED_BY_COMPUTE_SHADER: [const] int32   = 0x930B;
GL_TOP_LEVEL_ARRAY_SIZE: [const] int32           = 0x930C;
GL_TOP_LEVEL_ARRAY_STRIDE: [const] int32         = 0x930D;
GL_LOCATION: [const] int32                       = 0x930E;
GL_LOCATION_INDEX: [const] int32                 = 0x930F;
GL_IS_PER_PATCH: [const] int32                   = 0x92E7;
GL_SHADER_STORAGE_BUFFER: [const] int32          = 0x90D2;
GL_SHADER_STORAGE_BUFFER_BINDING: [const] int32  = 0x90D3;
GL_SHADER_STORAGE_BUFFER_START: [const] int32    = 0x90D4;
GL_SHADER_STORAGE_BUFFER_SIZE: [const] int32     = 0x90D5;
GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90D6;
GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90D7;
GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90D8;
GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90D9;
GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90DA;
GL_MAX_COMPUTE_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90DB;
GL_MAX_COMBINED_SHADER_STORAGE_BLOCKS: [const] int32 = 0x90DC;
GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS: [const] int32 = 0x90DD;
GL_MAX_SHADER_STORAGE_BLOCK_SIZE: [const] int32  = 0x90DE;
GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT: [const] int32 = 0x90DF;
GL_SHADER_STORAGE_BARRIER_BIT: [const] int32     = 0x00002000;
GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES: [const] int32 = 0x8F39;
GL_DEPTH_STENCIL_TEXTURE_MODE: [const] int32     = 0x90EA;
GL_TEXTURE_BUFFER_OFFSET: [const] int32          = 0x919D;
GL_TEXTURE_BUFFER_SIZE: [const] int32            = 0x919E;
GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT: [const] int32 = 0x919F;
GL_TEXTURE_VIEW_MIN_LEVEL: [const] int32         = 0x82DB;
GL_TEXTURE_VIEW_NUM_LEVELS: [const] int32        = 0x82DC;
GL_TEXTURE_VIEW_MIN_LAYER: [const] int32         = 0x82DD;
GL_TEXTURE_VIEW_NUM_LAYERS: [const] int32        = 0x82DE;
GL_TEXTURE_IMMUTABLE_LEVELS: [const] int32       = 0x82DF;
GL_VERTEX_ATTRIB_BINDING: [const] int32          = 0x82D4;
GL_VERTEX_ATTRIB_RELATIVE_OFFSET: [const] int32  = 0x82D5;
GL_VERTEX_BINDING_DIVISOR: [const] int32         = 0x82D6;
GL_VERTEX_BINDING_OFFSET: [const] int32          = 0x82D7;
GL_VERTEX_BINDING_STRIDE: [const] int32          = 0x82D8;
GL_MAX_VERTEX_ATTRIB_RELATIVE_OFFSET: [const] int32 = 0x82D9;
GL_MAX_VERTEX_ATTRIB_BINDINGS: [const] int32     = 0x82DA;
GL_VERTEX_BINDING_BUFFER: [const] int32          = 0x8F4F;
...
GL_MAX_VERTEX_ATTRIB_STRIDE: [const] int32       = 0x82E5;
GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED: [const] int32 = 0x8221;
GL_TEXTURE_BUFFER_BINDING: [const] int32         = 0x8C2A;
GL_MAP_PERSISTENT_BIT: [const] int32             = 0x0040;
GL_MAP_COHERENT_BIT: [const] int32               = 0x0080;
GL_DYNAMIC_STORAGE_BIT: [const] int32            = 0x0100;
GL_CLIENT_STORAGE_BIT: [const] int32             = 0x0200;
GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT: [const] int32 = 0x00004000;
GL_BUFFER_IMMUTABLE_STORAGE: [const] int32       = 0x821F;
GL_BUFFER_STORAGE_FLAGS: [const] int32           = 0x8220;
GL_CLEAR_TEXTURE: [const] int32                  = 0x9365;
GL_LOCATION_COMPONENT: [const] int32             = 0x934A;
GL_TRANSFORM_FEEDBACK_BUFFER_INDEX: [const] int32 = 0x934B;
GL_TRANSFORM_FEEDBACK_BUFFER_STRIDE: [const] int32 = 0x934C;
GL_QUERY_BUFFER: [const] int32                   = 0x9192;
GL_QUERY_BUFFER_BARRIER_BIT: [const] int32       = 0x00008000;
GL_QUERY_BUFFER_BINDING: [const] int32           = 0x9193;
GL_QUERY_RESULT_NO_WAIT: [const] int32           = 0x9194;
GL_MIRROR_CLAMP_TO_EDGE: [const] int32           = 0x8743;
...
GL_CONTEXT_LOST: [const] int32                   = 0x0507;
GL_NEGATIVE_ONE_TO_ONE: [const] int32            = 0x935E;
GL_ZERO_TO_ONE: [const] int32                    = 0x935F;
GL_CLIP_ORIGIN: [const] int32                    = 0x935C;
GL_CLIP_DEPTH_MODE: [const] int32                = 0x935D;
GL_QUERY_WAIT_INVERTED: [const] int32            = 0x8E17;
GL_QUERY_NO_WAIT_INVERTED: [const] int32         = 0x8E18;
GL_QUERY_BY_REGION_WAIT_INVERTED: [const] int32  = 0x8E19;
GL_QUERY_BY_REGION_NO_WAIT_INVERTED: [const] int32 = 0x8E1A;
GL_MAX_CULL_DISTANCES: [const] int32             = 0x82F9;
GL_MAX_COMBINED_CLIP_AND_CULL_DISTANCES: [const] int32 = 0x82FA;
GL_TEXTURE_TARGET: [const] int32                 = 0x1006;
GL_QUERY_TARGET: [const] int32                   = 0x82EA;
GL_GUILTY_CONTEXT_RESET: [const] int32           = 0x8253;
GL_INNOCENT_CONTEXT_RESET: [const] int32         = 0x8254;
GL_UNKNOWN_CONTEXT_RESET: [const] int32          = 0x8255;
GL_RESET_NOTIFICATION_STRATEGY: [const] int32    = 0x8256;
GL_LOSE_CONTEXT_ON_RESET: [const] int32          = 0x8252;
GL_NO_RESET_NOTIFICATION: [const] int32          = 0x8261;
GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT: [const] int32 = 0x00000004;
GL_CONTEXT_RELEASE_BEHAVIOR: [const] int32       = 0x82FB;
GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH: [const] int32 = 0x82FC;
...
GL_SHADER_BINARY_FORMAT_SPIR_V: [const] int32    = 0x9551;
GL_SPIR_V_BINARY: [const] int32                  = 0x9552;
GL_PARAMETER_BUFFER: [const] int32               = 0x80EE;
GL_PARAMETER_BUFFER_BINDING: [const] int32       = 0x80EF;
GL_CONTEXT_FLAG_NO_ERROR_BIT: [const] int32      = 0x00000008;
GL_VERTICES_SUBMITTED: [const] int32             = 0x82EE;
GL_PRIMITIVES_SUBMITTED: [const] int32           = 0x82EF;
GL_VERTEX_SHADER_INVOCATIONS: [const] int32      = 0x82F0;
GL_TESS_CONTROL_SHADER_PATCHES: [const] int32    = 0x82F1;
GL_TESS_EVALUATION_SHADER_INVOCATIONS: [const] int32 = 0x82F2;
GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED: [const] int32 = 0x82F3;
GL_FRAGMENT_SHADER_INVOCATIONS: [const] int32    = 0x82F4;
GL_COMPUTE_SHADER_INVOCATIONS: [const] int32     = 0x82F5;
GL_CLIPPING_INPUT_PRIMITIVES: [const] int32      = 0x82F6;
GL_CLIPPING_OUTPUT_PRIMITIVES: [const] int32     = 0x82F7;
GL_POLYGON_OFFSET_CLAMP: [const] int32           = 0x8E1B;
GL_SPIR_V_EXTENSIONS: [const] int32              = 0x9553;
GL_NUM_SPIR_V_EXTENSIONS: [const] int32          = 0x9554;
GL_TEXTURE_MAX_ANISOTROPY: [const] int32         = 0x84FE;
GL_MAX_TEXTURE_MAX_ANISOTROPY: [const] int32     = 0x84FF;
GL_TRANSFORM_FEEDBACK_OVERFLOW: [const] int32    = 0x82EC;
GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW: [const] int32 = 0x82ED;
...
GL_PRIMITIVE_BOUNDING_BOX_ARB: [const] int32     = 0x92BE;
GL_MULTISAMPLE_LINE_WIDTH_RANGE_ARB: [const] int32 = 0x9381;
GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY_ARB: [const] int32 = 0x9382;
...
GL_UNSIGNED_INT64_ARB: [const] int32             = 0x140F;
...
GL_SYNC_CL_EVENT_ARB: [const] int32              = 0x8240;
GL_SYNC_CL_EVENT_COMPLETE_ARB: [const] int32     = 0x8241;
...
GL_MAX_COMPUTE_VARIABLE_GROUP_INVOCATIONS_ARB: [const] int32 = 0x9344;
GL_MAX_COMPUTE_FIXED_GROUP_INVOCATIONS_ARB: [const] int32 = 0x90EB;
GL_MAX_COMPUTE_VARIABLE_GROUP_SIZE_ARB: [const] int32 = 0x9345;
GL_MAX_COMPUTE_FIXED_GROUP_SIZE_ARB: [const] int32 = 0x91BF;
...
GL_DEBUG_OUTPUT_SYNCHRONOUS_ARB: [const] int32   = 0x8242;
GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH_ARB: [const] int32 = 0x8243;
GL_DEBUG_CALLBACK_FUNCTION_ARB: [const] int32    = 0x8244;
GL_DEBUG_CALLBACK_USER_PARAM_ARB: [const] int32  = 0x8245;
GL_DEBUG_SOURCE_API_ARB: [const] int32           = 0x8246;
GL_DEBUG_SOURCE_WINDOW_SYSTEM_ARB: [const] int32 = 0x8247;
GL_DEBUG_SOURCE_SHADER_COMPILER_ARB: [const] int32 = 0x8248;
GL_DEBUG_SOURCE_THIRD_PARTY_ARB: [const] int32   = 0x8249;
GL_DEBUG_SOURCE_APPLICATION_ARB: [const] int32   = 0x824A;
GL_DEBUG_SOURCE_OTHER_ARB: [const] int32         = 0x824B;
GL_DEBUG_TYPE_ERROR_ARB: [const] int32           = 0x824C;
GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR_ARB: [const] int32 = 0x824D;
GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR_ARB: [const] int32 = 0x824E;
GL_DEBUG_TYPE_PORTABILITY_ARB: [const] int32     = 0x824F;
GL_DEBUG_TYPE_PERFORMANCE_ARB: [const] int32     = 0x8250;
GL_DEBUG_TYPE_OTHER_ARB: [const] int32           = 0x8251;
GL_MAX_DEBUG_MESSAGE_LENGTH_ARB: [const] int32   = 0x9143;
GL_MAX_DEBUG_LOGGED_MESSAGES_ARB: [const] int32  = 0x9144;
GL_DEBUG_LOGGED_MESSAGES_ARB: [const] int32      = 0x9145;
GL_DEBUG_SEVERITY_HIGH_ARB: [const] int32        = 0x9146;
GL_DEBUG_SEVERITY_MEDIUM_ARB: [const] int32      = 0x9147;
GL_DEBUG_SEVERITY_LOW_ARB: [const] int32         = 0x9148;
...
GL_LINES_ADJACENCY_ARB: [const] int32            = 0x000A;
GL_LINE_STRIP_ADJACENCY_ARB: [const] int32       = 0x000B;
GL_TRIANGLES_ADJACENCY_ARB: [const] int32        = 0x000C;
GL_TRIANGLE_STRIP_ADJACENCY_ARB: [const] int32   = 0x000D;
GL_PROGRAM_POINT_SIZE_ARB: [const] int32         = 0x8642;
GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_ARB: [const] int32 = 0x8C29;
GL_FRAMEBUFFER_ATTACHMENT_LAYERED_ARB: [const] int32 = 0x8DA7;
GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_ARB: [const] int32 = 0x8DA8;
GL_FRAMEBUFFER_INCOMPLETE_LAYER_COUNT_ARB: [const] int32 = 0x8DA9;
GL_GEOMETRY_SHADER_ARB: [const] int32            = 0x8DD9;
GL_GEOMETRY_VERTICES_OUT_ARB: [const] int32      = 0x8DDA;
GL_GEOMETRY_INPUT_TYPE_ARB: [const] int32        = 0x8DDB;
GL_GEOMETRY_OUTPUT_TYPE_ARB: [const] int32       = 0x8DDC;
GL_MAX_GEOMETRY_VARYING_COMPONENTS_ARB: [const] int32 = 0x8DDD;
GL_MAX_VERTEX_VARYING_COMPONENTS_ARB: [const] int32 = 0x8DDE;
GL_MAX_GEOMETRY_UNIFORM_COMPONENTS_ARB: [const] int32 = 0x8DDF;
GL_MAX_GEOMETRY_OUTPUT_VERTICES_ARB: [const] int32 = 0x8DE0;
GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_ARB: [const] int32 = 0x8DE1;
...
GL_SHADER_BINARY_FORMAT_SPIR_V_ARB: [const] int32 = 0x9551;
GL_SPIR_V_BINARY_ARB: [const] int32              = 0x9552;
...
GL_INT64_ARB: [const] int32                      = 0x140E;
GL_INT64_VEC2_ARB: [const] int32                 = 0x8FE9;
GL_INT64_VEC3_ARB: [const] int32                 = 0x8FEA;
GL_INT64_VEC4_ARB: [const] int32                 = 0x8FEB;
GL_UNSIGNED_INT64_VEC2_ARB: [const] int32        = 0x8FF5;
GL_UNSIGNED_INT64_VEC3_ARB: [const] int32        = 0x8FF6;
GL_UNSIGNED_INT64_VEC4_ARB: [const] int32        = 0x8FF7;
...
GL_PARAMETER_BUFFER_ARB: [const] int32           = 0x80EE;
GL_PARAMETER_BUFFER_BINDING_ARB: [const] int32   = 0x80EF;
...
GL_VERTEX_ATTRIB_ARRAY_DIVISOR_ARB: [const] int32 = 0x88FE;
...
GL_SRGB_DECODE_ARB: [const] int32                = 0x8299;
GL_VIEW_CLASS_EAC_R11: [const] int32             = 0x9383;
GL_VIEW_CLASS_EAC_RG11: [const] int32            = 0x9384;
GL_VIEW_CLASS_ETC2_RGB: [const] int32            = 0x9385;
GL_VIEW_CLASS_ETC2_RGBA: [const] int32           = 0x9386;
GL_VIEW_CLASS_ETC2_EAC_RGBA: [const] int32       = 0x9387;
GL_VIEW_CLASS_ASTC_4x4_RGBA: [const] int32       = 0x9388;
GL_VIEW_CLASS_ASTC_5x4_RGBA: [const] int32       = 0x9389;
GL_VIEW_CLASS_ASTC_5x5_RGBA: [const] int32       = 0x938A;
GL_VIEW_CLASS_ASTC_6x5_RGBA: [const] int32       = 0x938B;
GL_VIEW_CLASS_ASTC_6x6_RGBA: [const] int32       = 0x938C;
GL_VIEW_CLASS_ASTC_8x5_RGBA: [const] int32       = 0x938D;
GL_VIEW_CLASS_ASTC_8x6_RGBA: [const] int32       = 0x938E;
GL_VIEW_CLASS_ASTC_8x8_RGBA: [const] int32       = 0x938F;
GL_VIEW_CLASS_ASTC_10x5_RGBA: [const] int32      = 0x9390;
GL_VIEW_CLASS_ASTC_10x6_RGBA: [const] int32      = 0x9391;
GL_VIEW_CLASS_ASTC_10x8_RGBA: [const] int32      = 0x9392;
GL_VIEW_CLASS_ASTC_10x10_RGBA: [const] int32     = 0x9393;
GL_VIEW_CLASS_ASTC_12x10_RGBA: [const] int32     = 0x9394;
GL_VIEW_CLASS_ASTC_12x12_RGBA: [const] int32     = 0x9395;

GL_MAX_SHADER_COMPILER_THREADS_ARB: [const] int32 = 0x91B0;
GL_COMPLETION_STATUS_ARB: [const] int32          = 0x91B1;

def PFNGLMAXSHADERCOMPILERTHREADSARBPROC = (count: GLuint)(void)*;

@[c]glMaxShaderCompilerThreadsARB(count: GLuint): void;

GL_VERTICES_SUBMITTED_ARB: [const] int32         = 0x82EE;
GL_PRIMITIVES_SUBMITTED_ARB: [const] int32       = 0x82EF;
GL_VERTEX_SHADER_INVOCATIONS_ARB: [const] int32  = 0x82F0;
GL_TESS_CONTROL_SHADER_PATCHES_ARB: [const] int32 = 0x82F1;
GL_TESS_EVALUATION_SHADER_INVOCATIONS_ARB: [const] int32 = 0x82F2;
GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED_ARB: [const] int32 = 0x82F3;
GL_FRAGMENT_SHADER_INVOCATIONS_ARB: [const] int32 = 0x82F4;
GL_COMPUTE_SHADER_INVOCATIONS_ARB: [const] int32 = 0x82F5;
GL_CLIPPING_INPUT_PRIMITIVES_ARB: [const] int32  = 0x82F6;
GL_CLIPPING_OUTPUT_PRIMITIVES_ARB: [const] int32 = 0x82F7;

GL_PIXEL_PACK_BUFFER_ARB: [const] int32          = 0x88EB;
GL_PIXEL_UNPACK_BUFFER_ARB: [const] int32        = 0x88EC;
GL_PIXEL_PACK_BUFFER_BINDING_ARB: [const] int32  = 0x88ED;
GL_PIXEL_UNPACK_BUFFER_BINDING_ARB: [const] int32 = 0x88EF;

GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT_ARB: [const] int32 = 0x00000004;
GL_LOSE_CONTEXT_ON_RESET_ARB: [const] int32      = 0x8252;
GL_GUILTY_CONTEXT_RESET_ARB: [const] int32       = 0x8253;
GL_INNOCENT_CONTEXT_RESET_ARB: [const] int32     = 0x8254;
GL_UNKNOWN_CONTEXT_RESET_ARB: [const] int32      = 0x8255;
GL_RESET_NOTIFICATION_STRATEGY_ARB: [const] int32 = 0x8256;
GL_NO_RESET_NOTIFICATION_ARB: [const] int32      = 0x8261;
...
GL_SAMPLE_LOCATION_SUBPIXEL_BITS_ARB: [const] int32 = 0x933D;
GL_SAMPLE_LOCATION_PIXEL_GRID_WIDTH_ARB: [const] int32 = 0x933E;
GL_SAMPLE_LOCATION_PIXEL_GRID_HEIGHT_ARB: [const] int32 = 0x933F;
GL_PROGRAMMABLE_SAMPLE_LOCATION_TABLE_SIZE_ARB: [const] int32 = 0x9340;
GL_SAMPLE_LOCATION_ARB: [const] int32            = 0x8E50;
GL_PROGRAMMABLE_SAMPLE_LOCATION_ARB: [const] int32 = 0x9341;
GL_FRAMEBUFFER_PROGRAMMABLE_SAMPLE_LOCATIONS_ARB: [const] int32 = 0x9342;
GL_FRAMEBUFFER_SAMPLE_LOCATION_PIXEL_GRID_ARB: [const] int32 = 0x9343;
...
GL_SAMPLE_SHADING_ARB: [const] int32             = 0x8C36;
GL_MIN_SAMPLE_SHADING_VALUE_ARB: [const] int32   = 0x8C37;

def PFNGLMINSAMPLESHADINGARBPROC = (value: GLfloat)(void)*;

@[c]glMinSampleShadingARB(value: GLfloat): void;

GL_SHADER_INCLUDE_ARB: [const] int32             = 0x8DAE;
GL_NAMED_STRING_LENGTH_ARB: [const] int32        = 0x8DE9;
GL_NAMED_STRING_TYPE_ARB: [const] int32          = 0x8DEA;
...
GL_SPARSE_STORAGE_BIT_ARB: [const] int32         = 0x0400;
GL_SPARSE_BUFFER_PAGE_SIZE_ARB: [const] int32    = 0x82F8;
...
GL_TEXTURE_SPARSE_ARB: [const] int32             = 0x91A6;
GL_VIRTUAL_PAGE_SIZE_INDEX_ARB: [const] int32    = 0x91A7;
GL_NUM_SPARSE_LEVELS_ARB: [const] int32          = 0x91AA;
GL_NUM_VIRTUAL_PAGE_SIZES_ARB: [const] int32     = 0x91A8;
GL_VIRTUAL_PAGE_SIZE_X_ARB: [const] int32        = 0x9195;
GL_VIRTUAL_PAGE_SIZE_Y_ARB: [const] int32        = 0x9196;
GL_VIRTUAL_PAGE_SIZE_Z_ARB: [const] int32        = 0x9197;
GL_MAX_SPARSE_TEXTURE_SIZE_ARB: [const] int32    = 0x9198;
GL_MAX_SPARSE_3D_TEXTURE_SIZE_ARB: [const] int32 = 0x9199;
GL_MAX_SPARSE_ARRAY_TEXTURE_LAYERS_ARB: [const] int32 = 0x919A;
GL_SPARSE_TEXTURE_FULL_ARRAY_CUBE_MIPMAPS_ARB: [const] int32 = 0x91A9;
...
GL_CLAMP_TO_BORDER_ARB: [const] int32            = 0x812D;

GL_TEXTURE_BUFFER_ARB: [const] int32             = 0x8C2A;
GL_MAX_TEXTURE_BUFFER_SIZE_ARB: [const] int32    = 0x8C2B;
GL_TEXTURE_BINDING_BUFFER_ARB: [const] int32     = 0x8C2C;
GL_TEXTURE_BUFFER_DATA_STORE_BINDING_ARB: [const] int32 = 0x8C2D;
GL_TEXTURE_BUFFER_FORMAT_ARB: [const] int32      = 0x8C2E;
...
GL_COMPRESSED_RGBA_BPTC_UNORM_ARB: [const] int32 = 0x8E8C;
GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM_ARB: [const] int32 = 0x8E8D;
GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT_ARB: [const] int32 = 0x8E8E;
GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_ARB: [const] int32 = 0x8E8F;

GL_TEXTURE_CUBE_MAP_ARRAY_ARB: [const] int32     = 0x9009;
GL_TEXTURE_BINDING_CUBE_MAP_ARRAY_ARB: [const] int32 = 0x900A;
GL_PROXY_TEXTURE_CUBE_MAP_ARRAY_ARB: [const] int32 = 0x900B;
GL_SAMPLER_CUBE_MAP_ARRAY_ARB: [const] int32     = 0x900C;
GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW_ARB: [const] int32 = 0x900D;
GL_INT_SAMPLER_CUBE_MAP_ARRAY_ARB: [const] int32 = 0x900E;
GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY_ARB: [const] int32 = 0x900F;

GL_TEXTURE_REDUCTION_MODE_ARB: [const] int32     = 0x9366;
GL_WEIGHTED_AVERAGE_ARB: [const] int32           = 0x9367;

GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET_ARB: [const] int32 = 0x8E5E;
GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET_ARB: [const] int32 = 0x8E5F;
GL_MAX_PROGRAM_TEXTURE_GATHER_COMPONENTS_ARB: [const] int32 = 0x8F9F;

GL_MIRRORED_REPEAT_ARB: [const] int32            = 0x8370;

GL_TRANSFORM_FEEDBACK_OVERFLOW_ARB: [const] int32 = 0x82EC;
GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW_ARB: [const] int32 = 0x82ED;
...
GL_MULTIPLY_KHR: [const] int32                   = 0x9294;
GL_SCREEN_KHR: [const] int32                     = 0x9295;
GL_OVERLAY_KHR: [const] int32                    = 0x9296;
GL_DARKEN_KHR: [const] int32                     = 0x9297;
GL_LIGHTEN_KHR: [const] int32                    = 0x9298;
GL_COLORDODGE_KHR: [const] int32                 = 0x9299;
GL_COLORBURN_KHR: [const] int32                  = 0x929A;
GL_HARDLIGHT_KHR: [const] int32                  = 0x929B;
GL_SOFTLIGHT_KHR: [const] int32                  = 0x929C;
GL_DIFFERENCE_KHR: [const] int32                 = 0x929E;
GL_EXCLUSION_KHR: [const] int32                  = 0x92A0;
GL_HSL_HUE_KHR: [const] int32                    = 0x92AD;
GL_HSL_SATURATION_KHR: [const] int32             = 0x92AE;
GL_HSL_COLOR_KHR: [const] int32                  = 0x92AF;
GL_HSL_LUMINOSITY_KHR: [const] int32             = 0x92B0;

def PFNGLBLENDBARRIERKHRPROC = ()(void)*;

@[c]glBlendBarrierKHR::void;

GL_BLEND_ADVANCED_COHERENT_KHR: [const] int32    = 0x9285;

GL_CONTEXT_FLAG_NO_ERROR_BIT_KHR: [const] int32  = 0x00000008;

GL_MAX_SHADER_COMPILER_THREADS_KHR: [const] int32 = 0x91B0;
GL_COMPLETION_STATUS_KHR: [const] int32          = 0x91B1;

def PFNGLMAXSHADERCOMPILERTHREADSKHRPROC = (count: GLuint)(void)*;

@[c]glMaxShaderCompilerThreadsKHR(count: GLuint): void;

GL_CONTEXT_ROBUST_ACCESS: [const] int32          = 0x90F3;

GL_SUBGROUP_SIZE_KHR: [const] int32              = 0x9532;
GL_SUBGROUP_SUPPORTED_STAGES_KHR: [const] int32  = 0x9533;
GL_SUBGROUP_SUPPORTED_FEATURES_KHR: [const] int32 = 0x9534;
GL_SUBGROUP_QUAD_ALL_STAGES_KHR: [const] int32   = 0x9535;
GL_SUBGROUP_FEATURE_BASIC_BIT_KHR: [const] int32 = 0x00000001;
GL_SUBGROUP_FEATURE_VOTE_BIT_KHR: [const] int32  = 0x00000002;
GL_SUBGROUP_FEATURE_ARITHMETIC_BIT_KHR: [const] int32 = 0x00000004;
GL_SUBGROUP_FEATURE_BALLOT_BIT_KHR: [const] int32 = 0x00000008;
GL_SUBGROUP_FEATURE_SHUFFLE_BIT_KHR: [const] int32 = 0x00000010;
GL_SUBGROUP_FEATURE_SHUFFLE_RELATIVE_BIT_KHR: [const] int32 = 0x00000020;
GL_SUBGROUP_FEATURE_CLUSTERED_BIT_KHR: [const] int32 = 0x00000040;
GL_SUBGROUP_FEATURE_QUAD_BIT_KHR: [const] int32  = 0x00000080;

GL_COMPRESSED_RGBA_ASTC_4x4_KHR: [const] int32   = 0x93B0;
GL_COMPRESSED_RGBA_ASTC_5x4_KHR: [const] int32   = 0x93B1;
GL_COMPRESSED_RGBA_ASTC_5x5_KHR: [const] int32   = 0x93B2;
GL_COMPRESSED_RGBA_ASTC_6x5_KHR: [const] int32   = 0x93B3;
GL_COMPRESSED_RGBA_ASTC_6x6_KHR: [const] int32   = 0x93B4;
GL_COMPRESSED_RGBA_ASTC_8x5_KHR: [const] int32   = 0x93B5;
GL_COMPRESSED_RGBA_ASTC_8x6_KHR: [const] int32   = 0x93B6;
GL_COMPRESSED_RGBA_ASTC_8x8_KHR: [const] int32   = 0x93B7;
GL_COMPRESSED_RGBA_ASTC_10x5_KHR: [const] int32  = 0x93B8;
GL_COMPRESSED_RGBA_ASTC_10x6_KHR: [const] int32  = 0x93B9;
GL_COMPRESSED_RGBA_ASTC_10x8_KHR: [const] int32  = 0x93BA;
GL_COMPRESSED_RGBA_ASTC_10x10_KHR: [const] int32 = 0x93BB;
GL_COMPRESSED_RGBA_ASTC_12x10_KHR: [const] int32 = 0x93BC;
GL_COMPRESSED_RGBA_ASTC_12x12_KHR: [const] int32 = 0x93BD;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR: [const] int32 = 0x93D0;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR: [const] int32 = 0x93D1;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR: [const] int32 = 0x93D2;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR: [const] int32 = 0x93D3;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR: [const] int32 = 0x93D4;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR: [const] int32 = 0x93D5;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR: [const] int32 = 0x93D6;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR: [const] int32 = 0x93D7;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR: [const] int32 = 0x93D8;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR: [const] int32 = 0x93D9;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR: [const] int32 = 0x93DA;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR: [const] int32 = 0x93DB;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR: [const] int32 = 0x93DC;
GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR: [const] int32 = 0x93DD;

GL_RENDERBUFFER_STORAGE_SAMPLES_AMD: [const] int32 = 0x91B2;
GL_MAX_COLOR_FRAMEBUFFER_SAMPLES_AMD: [const] int32 = 0x91B3;
GL_MAX_COLOR_FRAMEBUFFER_STORAGE_SAMPLES_AMD: [const] int32 = 0x91B4;
GL_MAX_DEPTH_STENCIL_FRAMEBUFFER_SAMPLES_AMD: [const] int32 = 0x91B5;
GL_NUM_SUPPORTED_MULTISAMPLE_MODES_AMD: [const] int32 = 0x91B6;
GL_SUPPORTED_MULTISAMPLE_MODES_AMD: [const] int32 = 0x91B7;
...
GL_COUNTER_TYPE_AMD: [const] int32               = 0x8BC0;
GL_COUNTER_RANGE_AMD: [const] int32              = 0x8BC1;
GL_UNSIGNED_INT64_AMD: [const] int32             = 0x8BC2;
GL_PERCENTAGE_AMD: [const] int32                 = 0x8BC3;
GL_PERFMON_RESULT_AVAILABLE_AMD: [const] int32   = 0x8BC4;
GL_PERFMON_RESULT_SIZE_AMD: [const] int32        = 0x8BC5;
GL_PERFMON_RESULT_AMD: [const] int32             = 0x8BC6;
...
GL_RGB_422_APPLE: [const] int32                  = 0x8A1F;
GL_UNSIGNED_SHORT_8_8_APPLE: [const] int32       = 0x85BA;
GL_UNSIGNED_SHORT_8_8_REV_APPLE: [const] int32   = 0x85BB;
GL_RGB_RAW_422_APPLE: [const] int32              = 0x8A51;
...
GL_PROGRAM_PIPELINE_OBJECT_EXT: [const] int32    = 0x8A4F;
GL_PROGRAM_OBJECT_EXT: [const] int32             = 0x8B40;
GL_SHADER_OBJECT_EXT: [const] int32              = 0x8B48;
GL_BUFFER_OBJECT_EXT: [const] int32              = 0x9151;
GL_QUERY_OBJECT_EXT: [const] int32               = 0x9153;
GL_VERTEX_ARRAY_OBJECT_EXT: [const] int32        = 0x9154;
...
GL_PROGRAM_MATRIX_EXT: [const] int32             = 0x8E2D;
GL_TRANSPOSE_PROGRAM_MATRIX_EXT: [const] int32   = 0x8E2E;
GL_PROGRAM_MATRIX_STACK_DEPTH_EXT: [const] int32 = 0x8E2F;
...
GL_POLYGON_OFFSET_CLAMP_EXT: [const] int32       = 0x8E1B;
...
GL_RASTER_MULTISAMPLE_EXT: [const] int32         = 0x9327;
GL_RASTER_SAMPLES_EXT: [const] int32             = 0x9328;
GL_MAX_RASTER_SAMPLES_EXT: [const] int32         = 0x9329;
GL_RASTER_FIXED_SAMPLE_LOCATIONS_EXT: [const] int32 = 0x932A;
GL_MULTISAMPLE_RASTERIZATION_ALLOWED_EXT: [const] int32 = 0x932B;
GL_EFFECTIVE_RASTER_SAMPLES_EXT: [const] int32   = 0x932C;
...
GL_ACTIVE_PROGRAM_EXT: [const] int32             = 0x8B8D;
...
GL_FRAGMENT_SHADER_DISCARDS_SAMPLES_EXT: [const] int32 = 0x8A52;

def PFNGLFRAMEBUFFERFETCHBARRIEREXTPROC = ()(void)*;

@[c]glFramebufferFetchBarrierEXT::void;

GL_COMPRESSED_RGB_S3TC_DXT1_EXT: [const] int32   = 0x83F0;
GL_COMPRESSED_RGBA_S3TC_DXT1_EXT: [const] int32  = 0x83F1;
GL_COMPRESSED_RGBA_S3TC_DXT3_EXT: [const] int32  = 0x83F2;
GL_COMPRESSED_RGBA_S3TC_DXT5_EXT: [const] int32  = 0x83F3;

GL_TEXTURE_REDUCTION_MODE_EXT: [const] int32     = 0x9366;
GL_WEIGHTED_AVERAGE_EXT: [const] int32           = 0x9367;

GL_SR8_EXT: [const] int32                        = 0x8FBD;

GL_SRG8_EXT: [const] int32                       = 0x8FBE;

GL_TEXTURE_SRGB_DECODE_EXT: [const] int32        = 0x8A48;
GL_DECODE_EXT: [const] int32                     = 0x8A49;
GL_SKIP_DECODE_EXT: [const] int32                = 0x8A4A;

GL_TEXTURE_IMMUTABLE_FORMAT_EXT: [const] int32   = 0x912F;
GL_ALPHA8_EXT: [const] int32                     = 0x803C;
GL_LUMINANCE8_EXT: [const] int32                 = 0x8040;
GL_LUMINANCE8_ALPHA8_EXT: [const] int32          = 0x8045;
GL_RGBA32F_EXT: [const] int32                    = 0x8814;
GL_RGB32F_EXT: [const] int32                     = 0x8815;
GL_ALPHA32F_EXT: [const] int32                   = 0x8816;
GL_LUMINANCE32F_EXT: [const] int32               = 0x8818;
GL_LUMINANCE_ALPHA32F_EXT: [const] int32         = 0x8819;
GL_RGBA16F_EXT: [const] int32                    = 0x881A;
GL_RGB16F_EXT: [const] int32                     = 0x881B;
GL_ALPHA16F_EXT: [const] int32                   = 0x881C;
GL_LUMINANCE16F_EXT: [const] int32               = 0x881E;
GL_LUMINANCE_ALPHA16F_EXT: [const] int32         = 0x881F;
GL_RGB10_A2_EXT: [const] int32                   = 0x8059;
GL_RGB10_EXT: [const] int32                      = 0x8052;
GL_BGRA8_EXT: [const] int32                      = 0x93A1;
GL_R8_EXT: [const] int32                         = 0x8229;
GL_RG8_EXT: [const] int32                        = 0x822B;
GL_R32F_EXT: [const] int32                       = 0x822E;
GL_RG32F_EXT: [const] int32                      = 0x8230;
GL_R16F_EXT: [const] int32                       = 0x822D;
GL_RG16F_EXT: [const] int32                      = 0x822F;
...
GL_INCLUSIVE_EXT: [const] int32                  = 0x8F10;
GL_EXCLUSIVE_EXT: [const] int32                  = 0x8F11;
GL_WINDOW_RECTANGLE_EXT: [const] int32           = 0x8F12;
GL_WINDOW_RECTANGLE_MODE_EXT: [const] int32      = 0x8F13;
GL_MAX_WINDOW_RECTANGLES_EXT: [const] int32      = 0x8F14;
GL_NUM_WINDOW_RECTANGLES_EXT: [const] int32      = 0x8F15;
...
GL_BLACKHOLE_RENDER_INTEL: [const] int32         = 0x83FC;

GL_CONSERVATIVE_RASTERIZATION_INTEL: [const] int32 = 0x83FE;

def PFNGLAPPLYFRAMEBUFFERATTACHMENTCMAAINTELPROC = ()(void)*;

@[c]glApplyFramebufferAttachmentCMAAINTEL::void;

GL_PERFQUERY_SINGLE_CONTEXT_INTEL: [const] int32 = 0x00000000;
GL_PERFQUERY_GLOBAL_CONTEXT_INTEL: [const] int32 = 0x00000001;
GL_PERFQUERY_WAIT_INTEL: [const] int32           = 0x83FB;
GL_PERFQUERY_FLUSH_INTEL: [const] int32          = 0x83FA;
GL_PERFQUERY_DONOT_FLUSH_INTEL: [const] int32    = 0x83F9;
GL_PERFQUERY_COUNTER_EVENT_INTEL: [const] int32  = 0x94F0;
GL_PERFQUERY_COUNTER_DURATION_NORM_INTEL: [const] int32 = 0x94F1;
GL_PERFQUERY_COUNTER_DURATION_RAW_INTEL: [const] int32 = 0x94F2;
GL_PERFQUERY_COUNTER_THROUGHPUT_INTEL: [const] int32 = 0x94F3;
GL_PERFQUERY_COUNTER_RAW_INTEL: [const] int32    = 0x94F4;
GL_PERFQUERY_COUNTER_TIMESTAMP_INTEL: [const] int32 = 0x94F5;
GL_PERFQUERY_COUNTER_DATA_UINT32_INTEL: [const] int32 = 0x94F8;
GL_PERFQUERY_COUNTER_DATA_UINT64_INTEL: [const] int32 = 0x94F9;
GL_PERFQUERY_COUNTER_DATA_FLOAT_INTEL: [const] int32 = 0x94FA;
GL_PERFQUERY_COUNTER_DATA_DOUBLE_INTEL: [const] int32 = 0x94FB;
GL_PERFQUERY_COUNTER_DATA_BOOL32_INTEL: [const] int32 = 0x94FC;
GL_PERFQUERY_QUERY_NAME_LENGTH_MAX_INTEL: [const] int32 = 0x94FD;
GL_PERFQUERY_COUNTER_NAME_LENGTH_MAX_INTEL: [const] int32 = 0x94FE;
GL_PERFQUERY_COUNTER_DESC_LENGTH_MAX_INTEL: [const] int32 = 0x94FF;
GL_PERFQUERY_GPA_EXTENDED_COUNTERS_INTEL: [const] int32 = 0x9500;
...
GL_FRAMEBUFFER_FLIP_X_MESA: [const] int32        = 0x8BBC;

GL_FRAMEBUFFER_FLIP_Y_MESA: [const] int32        = 0x8BBB;
...
GL_FRAMEBUFFER_SWAP_XY_MESA: [const] int32       = 0x8BBD;
...
GL_BLEND_OVERLAP_NV: [const] int32               = 0x9281;
GL_BLEND_PREMULTIPLIED_SRC_NV: [const] int32     = 0x9280;
GL_BLUE_NV: [const] int32                        = 0x1905;
GL_COLORBURN_NV: [const] int32                   = 0x929A;
GL_COLORDODGE_NV: [const] int32                  = 0x9299;
GL_CONJOINT_NV: [const] int32                    = 0x9284;
GL_CONTRAST_NV: [const] int32                    = 0x92A1;
GL_DARKEN_NV: [const] int32                      = 0x9297;
GL_DIFFERENCE_NV: [const] int32                  = 0x929E;
GL_DISJOINT_NV: [const] int32                    = 0x9283;
GL_DST_ATOP_NV: [const] int32                    = 0x928F;
GL_DST_IN_NV: [const] int32                      = 0x928B;
GL_DST_NV: [const] int32                         = 0x9287;
GL_DST_OUT_NV: [const] int32                     = 0x928D;
GL_DST_OVER_NV: [const] int32                    = 0x9289;
GL_EXCLUSION_NV: [const] int32                   = 0x92A0;
GL_GREEN_NV: [const] int32                       = 0x1904;
GL_HARDLIGHT_NV: [const] int32                   = 0x929B;
GL_HARDMIX_NV: [const] int32                     = 0x92A9;
GL_HSL_COLOR_NV: [const] int32                   = 0x92AF;
GL_HSL_HUE_NV: [const] int32                     = 0x92AD;
GL_HSL_LUMINOSITY_NV: [const] int32              = 0x92B0;
GL_HSL_SATURATION_NV: [const] int32              = 0x92AE;
GL_INVERT_OVG_NV: [const] int32                  = 0x92B4;
GL_INVERT_RGB_NV: [const] int32                  = 0x92A3;
GL_LIGHTEN_NV: [const] int32                     = 0x9298;
GL_LINEARBURN_NV: [const] int32                  = 0x92A5;
GL_LINEARDODGE_NV: [const] int32                 = 0x92A4;
GL_LINEARLIGHT_NV: [const] int32                 = 0x92A7;
GL_MINUS_CLAMPED_NV: [const] int32               = 0x92B3;
GL_MINUS_NV: [const] int32                       = 0x929F;
GL_MULTIPLY_NV: [const] int32                    = 0x9294;
GL_OVERLAY_NV: [const] int32                     = 0x9296;
GL_PINLIGHT_NV: [const] int32                    = 0x92A8;
GL_PLUS_CLAMPED_ALPHA_NV: [const] int32          = 0x92B2;
GL_PLUS_CLAMPED_NV: [const] int32                = 0x92B1;
GL_PLUS_DARKER_NV: [const] int32                 = 0x9292;
GL_PLUS_NV: [const] int32                        = 0x9291;
GL_RED_NV: [const] int32                         = 0x1903;
GL_SCREEN_NV: [const] int32                      = 0x9295;
GL_SOFTLIGHT_NV: [const] int32                   = 0x929C;
GL_SRC_ATOP_NV: [const] int32                    = 0x928E;
GL_SRC_IN_NV: [const] int32                      = 0x928A;
GL_SRC_NV: [const] int32                         = 0x9286;
GL_SRC_OUT_NV: [const] int32                     = 0x928C;
GL_SRC_OVER_NV: [const] int32                    = 0x9288;
GL_UNCORRELATED_NV: [const] int32                = 0x9282;
GL_VIVIDLIGHT_NV: [const] int32                  = 0x92A6;
GL_XOR_NV: [const] int32                         = 0x1506;
...
GL_BLEND_ADVANCED_COHERENT_NV: [const] int32     = 0x9285;

GL_FACTOR_MIN_AMD: [const] int32                 = 0x901C;
GL_FACTOR_MAX_AMD: [const] int32                 = 0x901D;

GL_VIEWPORT_POSITION_W_SCALE_NV: [const] int32   = 0x937C;
GL_VIEWPORT_POSITION_W_SCALE_X_COEFF_NV: [const] int32 = 0x937D;
GL_VIEWPORT_POSITION_W_SCALE_Y_COEFF_NV: [const] int32 = 0x937E;
...
GL_TERMINATE_SEQUENCE_COMMAND_NV: [const] int32  = 0x0000;
GL_NOP_COMMAND_NV: [const] int32                 = 0x0001;
GL_DRAW_ELEMENTS_COMMAND_NV: [const] int32       = 0x0002;
GL_DRAW_ARRAYS_COMMAND_NV: [const] int32         = 0x0003;
GL_DRAW_ELEMENTS_STRIP_COMMAND_NV: [const] int32 = 0x0004;
GL_DRAW_ARRAYS_STRIP_COMMAND_NV: [const] int32   = 0x0005;
GL_DRAW_ELEMENTS_INSTANCED_COMMAND_NV: [const] int32 = 0x0006;
GL_DRAW_ARRAYS_INSTANCED_COMMAND_NV: [const] int32 = 0x0007;
GL_ELEMENT_ADDRESS_COMMAND_NV: [const] int32     = 0x0008;
GL_ATTRIBUTE_ADDRESS_COMMAND_NV: [const] int32   = 0x0009;
GL_UNIFORM_ADDRESS_COMMAND_NV: [const] int32     = 0x000A;
GL_BLEND_COLOR_COMMAND_NV: [const] int32         = 0x000B;
GL_STENCIL_REF_COMMAND_NV: [const] int32         = 0x000C;
GL_LINE_WIDTH_COMMAND_NV: [const] int32          = 0x000D;
GL_POLYGON_OFFSET_COMMAND_NV: [const] int32      = 0x000E;
GL_ALPHA_REF_COMMAND_NV: [const] int32           = 0x000F;
GL_VIEWPORT_COMMAND_NV: [const] int32            = 0x0010;
GL_SCISSOR_COMMAND_NV: [const] int32             = 0x0011;
GL_FRONT_FACE_COMMAND_NV: [const] int32          = 0x0012;
...
GL_QUERY_WAIT_NV: [const] int32                  = 0x8E13;
GL_QUERY_NO_WAIT_NV: [const] int32               = 0x8E14;
GL_QUERY_BY_REGION_WAIT_NV: [const] int32        = 0x8E15;
GL_QUERY_BY_REGION_NO_WAIT_NV: [const] int32     = 0x8E16;
...
GL_CONSERVATIVE_RASTERIZATION_NV: [const] int32  = 0x9346;
GL_SUBPIXEL_PRECISION_BIAS_X_BITS_NV: [const] int32 = 0x9347;
GL_SUBPIXEL_PRECISION_BIAS_Y_BITS_NV: [const] int32 = 0x9348;
GL_MAX_SUBPIXEL_PRECISION_BIAS_BITS_NV: [const] int32 = 0x9349;
...
GL_CONSERVATIVE_RASTER_DILATE_NV: [const] int32  = 0x9379;
GL_CONSERVATIVE_RASTER_DILATE_RANGE_NV: [const] int32 = 0x937A;
GL_CONSERVATIVE_RASTER_DILATE_GRANULARITY_NV: [const] int32 = 0x937B;
...
GL_CONSERVATIVE_RASTER_MODE_PRE_SNAP_NV: [const] int32 = 0x9550;

GL_CONSERVATIVE_RASTER_MODE_NV: [const] int32    = 0x954D;
GL_CONSERVATIVE_RASTER_MODE_POST_SNAP_NV: [const] int32 = 0x954E;
GL_CONSERVATIVE_RASTER_MODE_PRE_SNAP_TRIANGLES_NV: [const] int32 = 0x954F;
...
GL_DEPTH_COMPONENT32F_NV: [const] int32          = 0x8DAB;
GL_DEPTH32F_STENCIL8_NV: [const] int32           = 0x8DAC;
GL_FLOAT_32_UNSIGNED_INT_24_8_REV_NV: [const] int32 = 0x8DAD;
GL_DEPTH_BUFFER_FLOAT_MODE_NV: [const] int32     = 0x8DAF;
...
GL_FILL_RECTANGLE_NV: [const] int32              = 0x933C;

GL_FRAGMENT_COVERAGE_TO_COLOR_NV: [const] int32  = 0x92DD;
GL_FRAGMENT_COVERAGE_COLOR_NV: [const] int32     = 0x92DE;

def PFNGLFRAGMENTCOVERAGECOLORNVPROC = (color: GLuint)(void)*;

@[c]glFragmentCoverageColorNV(color: GLuint): void;

GL_COVERAGE_MODULATION_TABLE_NV: [const] int32   = 0x9331;
GL_COLOR_SAMPLES_NV: [const] int32               = 0x8E20;
GL_DEPTH_SAMPLES_NV: [const] int32               = 0x932D;
GL_STENCIL_SAMPLES_NV: [const] int32             = 0x932E;
GL_MIXED_DEPTH_SAMPLES_SUPPORTED_NV: [const] int32 = 0x932F;
GL_MIXED_STENCIL_SAMPLES_SUPPORTED_NV: [const] int32 = 0x9330;
GL_COVERAGE_MODULATION_NV: [const] int32         = 0x9332;
GL_COVERAGE_MODULATION_TABLE_SIZE_NV: [const] int32 = 0x9333;
...
GL_RENDERBUFFER_COVERAGE_SAMPLES_NV: [const] int32 = 0x8CAB;
GL_RENDERBUFFER_COLOR_SAMPLES_NV: [const] int32  = 0x8E10;
GL_MAX_MULTISAMPLE_COVERAGE_MODES_NV: [const] int32 = 0x8E11;
GL_MULTISAMPLE_COVERAGE_MODES_NV: [const] int32  = 0x8E12;
...
GL_INT64_NV: [const] int32                       = 0x140E;
GL_UNSIGNED_INT64_NV: [const] int32              = 0x140F;
GL_INT8_NV: [const] int32                        = 0x8FE0;
GL_INT8_VEC2_NV: [const] int32                   = 0x8FE1;
GL_INT8_VEC3_NV: [const] int32                   = 0x8FE2;
GL_INT8_VEC4_NV: [const] int32                   = 0x8FE3;
GL_INT16_NV: [const] int32                       = 0x8FE4;
GL_INT16_VEC2_NV: [const] int32                  = 0x8FE5;
GL_INT16_VEC3_NV: [const] int32                  = 0x8FE6;
GL_INT16_VEC4_NV: [const] int32                  = 0x8FE7;
GL_INT64_VEC2_NV: [const] int32                  = 0x8FE9;
GL_INT64_VEC3_NV: [const] int32                  = 0x8FEA;
GL_INT64_VEC4_NV: [const] int32                  = 0x8FEB;
GL_UNSIGNED_INT8_NV: [const] int32               = 0x8FEC;
GL_UNSIGNED_INT8_VEC2_NV: [const] int32          = 0x8FED;
GL_UNSIGNED_INT8_VEC3_NV: [const] int32          = 0x8FEE;
GL_UNSIGNED_INT8_VEC4_NV: [const] int32          = 0x8FEF;
GL_UNSIGNED_INT16_NV: [const] int32              = 0x8FF0;
GL_UNSIGNED_INT16_VEC2_NV: [const] int32         = 0x8FF1;
GL_UNSIGNED_INT16_VEC3_NV: [const] int32         = 0x8FF2;
GL_UNSIGNED_INT16_VEC4_NV: [const] int32         = 0x8FF3;
GL_UNSIGNED_INT64_VEC2_NV: [const] int32         = 0x8FF5;
GL_UNSIGNED_INT64_VEC3_NV: [const] int32         = 0x8FF6;
GL_UNSIGNED_INT64_VEC4_NV: [const] int32         = 0x8FF7;
GL_FLOAT16_NV: [const] int32                     = 0x8FF8;
GL_FLOAT16_VEC2_NV: [const] int32                = 0x8FF9;
GL_FLOAT16_VEC3_NV: [const] int32                = 0x8FFA;
GL_FLOAT16_VEC4_NV: [const] int32                = 0x8FFB;
...
GL_MULTISAMPLES_NV: [const] int32                = 0x9371;
GL_SUPERSAMPLE_SCALE_X_NV: [const] int32         = 0x9372;
GL_SUPERSAMPLE_SCALE_Y_NV: [const] int32         = 0x9373;
GL_CONFORMANT_NV: [const] int32                  = 0x9374;
...
GL_ATTACHED_MEMORY_OBJECT_NV: [const] int32      = 0x95A4;
GL_ATTACHED_MEMORY_OFFSET_NV: [const] int32      = 0x95A5;
GL_MEMORY_ATTACHABLE_ALIGNMENT_NV: [const] int32 = 0x95A6;
GL_MEMORY_ATTACHABLE_SIZE_NV: [const] int32      = 0x95A7;
GL_MEMORY_ATTACHABLE_NV: [const] int32           = 0x95A8;
GL_DETACHED_MEMORY_INCARNATION_NV: [const] int32 = 0x95A9;
GL_DETACHED_TEXTURES_NV: [const] int32           = 0x95AA;
GL_DETACHED_BUFFERS_NV: [const] int32            = 0x95AB;
GL_MAX_DETACHED_TEXTURES_NV: [const] int32       = 0x95AC;
GL_MAX_DETACHED_BUFFERS_NV: [const] int32        = 0x95AD;
...
GL_MESH_SHADER_NV: [const] int32                 = 0x9559;
GL_TASK_SHADER_NV: [const] int32                 = 0x955A;
GL_MAX_MESH_UNIFORM_BLOCKS_NV: [const] int32     = 0x8E60;
GL_MAX_MESH_TEXTURE_IMAGE_UNITS_NV: [const] int32 = 0x8E61;
GL_MAX_MESH_IMAGE_UNIFORMS_NV: [const] int32     = 0x8E62;
GL_MAX_MESH_UNIFORM_COMPONENTS_NV: [const] int32 = 0x8E63;
GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_NV: [const] int32 = 0x8E64;
GL_MAX_MESH_ATOMIC_COUNTERS_NV: [const] int32    = 0x8E65;
GL_MAX_MESH_SHADER_STORAGE_BLOCKS_NV: [const] int32 = 0x8E66;
GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_NV: [const] int32 = 0x8E67;
GL_MAX_TASK_UNIFORM_BLOCKS_NV: [const] int32     = 0x8E68;
GL_MAX_TASK_TEXTURE_IMAGE_UNITS_NV: [const] int32 = 0x8E69;
GL_MAX_TASK_IMAGE_UNIFORMS_NV: [const] int32     = 0x8E6A;
GL_MAX_TASK_UNIFORM_COMPONENTS_NV: [const] int32 = 0x8E6B;
GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_NV: [const] int32 = 0x8E6C;
GL_MAX_TASK_ATOMIC_COUNTERS_NV: [const] int32    = 0x8E6D;
GL_MAX_TASK_SHADER_STORAGE_BLOCKS_NV: [const] int32 = 0x8E6E;
GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_NV: [const] int32 = 0x8E6F;
GL_MAX_MESH_WORK_GROUP_INVOCATIONS_NV: [const] int32 = 0x95A2;
GL_MAX_TASK_WORK_GROUP_INVOCATIONS_NV: [const] int32 = 0x95A3;
GL_MAX_MESH_TOTAL_MEMORY_SIZE_NV: [const] int32  = 0x9536;
GL_MAX_TASK_TOTAL_MEMORY_SIZE_NV: [const] int32  = 0x9537;
GL_MAX_MESH_OUTPUT_VERTICES_NV: [const] int32    = 0x9538;
GL_MAX_MESH_OUTPUT_PRIMITIVES_NV: [const] int32  = 0x9539;
GL_MAX_TASK_OUTPUT_COUNT_NV: [const] int32       = 0x953A;
GL_MAX_DRAW_MESH_TASKS_COUNT_NV: [const] int32   = 0x953D;
GL_MAX_MESH_VIEWS_NV: [const] int32              = 0x9557;
GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_NV: [const] int32 = 0x92DF;
GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_NV: [const] int32 = 0x9543;
GL_MAX_MESH_WORK_GROUP_SIZE_NV: [const] int32    = 0x953B;
GL_MAX_TASK_WORK_GROUP_SIZE_NV: [const] int32    = 0x953C;
GL_MESH_WORK_GROUP_SIZE_NV: [const] int32        = 0x953E;
GL_TASK_WORK_GROUP_SIZE_NV: [const] int32        = 0x953F;
GL_MESH_VERTICES_OUT_NV: [const] int32           = 0x9579;
GL_MESH_PRIMITIVES_OUT_NV: [const] int32         = 0x957A;
GL_MESH_OUTPUT_TYPE_NV: [const] int32            = 0x957B;
GL_UNIFORM_BLOCK_REFERENCED_BY_MESH_SHADER_NV: [const] int32 = 0x959C;
GL_UNIFORM_BLOCK_REFERENCED_BY_TASK_SHADER_NV: [const] int32 = 0x959D;
GL_REFERENCED_BY_MESH_SHADER_NV: [const] int32   = 0x95A0;
GL_REFERENCED_BY_TASK_SHADER_NV: [const] int32   = 0x95A1;
GL_MESH_SHADER_BIT_NV: [const] int32             = 0x00000040;
GL_TASK_SHADER_BIT_NV: [const] int32             = 0x00000080;
GL_MESH_SUBROUTINE_NV: [const] int32             = 0x957C;
GL_TASK_SUBROUTINE_NV: [const] int32             = 0x957D;
GL_MESH_SUBROUTINE_UNIFORM_NV: [const] int32     = 0x957E;
GL_TASK_SUBROUTINE_UNIFORM_NV: [const] int32     = 0x957F;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_MESH_SHADER_NV: [const] int32 = 0x959E;
GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TASK_SHADER_NV: [const] int32 = 0x959F;
...
GL_PATH_FORMAT_SVG_NV: [const] int32             = 0x9070;
GL_PATH_FORMAT_PS_NV: [const] int32              = 0x9071;
GL_STANDARD_FONT_NAME_NV: [const] int32          = 0x9072;
GL_SYSTEM_FONT_NAME_NV: [const] int32            = 0x9073;
GL_FILE_NAME_NV: [const] int32                   = 0x9074;
GL_PATH_STROKE_WIDTH_NV: [const] int32           = 0x9075;
GL_PATH_END_CAPS_NV: [const] int32               = 0x9076;
GL_PATH_INITIAL_END_CAP_NV: [const] int32        = 0x9077;
GL_PATH_TERMINAL_END_CAP_NV: [const] int32       = 0x9078;
GL_PATH_JOIN_STYLE_NV: [const] int32             = 0x9079;
GL_PATH_MITER_LIMIT_NV: [const] int32            = 0x907A;
GL_PATH_DASH_CAPS_NV: [const] int32              = 0x907B;
GL_PATH_INITIAL_DASH_CAP_NV: [const] int32       = 0x907C;
GL_PATH_TERMINAL_DASH_CAP_NV: [const] int32      = 0x907D;
GL_PATH_DASH_OFFSET_NV: [const] int32            = 0x907E;
GL_PATH_CLIENT_LENGTH_NV: [const] int32          = 0x907F;
GL_PATH_FILL_MODE_NV: [const] int32              = 0x9080;
GL_PATH_FILL_MASK_NV: [const] int32              = 0x9081;
GL_PATH_FILL_COVER_MODE_NV: [const] int32        = 0x9082;
GL_PATH_STROKE_COVER_MODE_NV: [const] int32      = 0x9083;
GL_PATH_STROKE_MASK_NV: [const] int32            = 0x9084;
GL_COUNT_UP_NV: [const] int32                    = 0x9088;
GL_COUNT_DOWN_NV: [const] int32                  = 0x9089;
GL_PATH_OBJECT_BOUNDING_BOX_NV: [const] int32    = 0x908A;
GL_CONVEX_HULL_NV: [const] int32                 = 0x908B;
GL_BOUNDING_BOX_NV: [const] int32                = 0x908D;
GL_TRANSLATE_X_NV: [const] int32                 = 0x908E;
GL_TRANSLATE_Y_NV: [const] int32                 = 0x908F;
GL_TRANSLATE_2D_NV: [const] int32                = 0x9090;
GL_TRANSLATE_3D_NV: [const] int32                = 0x9091;
GL_AFFINE_2D_NV: [const] int32                   = 0x9092;
GL_AFFINE_3D_NV: [const] int32                   = 0x9094;
GL_TRANSPOSE_AFFINE_2D_NV: [const] int32         = 0x9096;
GL_TRANSPOSE_AFFINE_3D_NV: [const] int32         = 0x9098;
GL_UTF8_NV: [const] int32                        = 0x909A;
GL_UTF16_NV: [const] int32                       = 0x909B;
GL_BOUNDING_BOX_OF_BOUNDING_BOXES_NV: [const] int32 = 0x909C;
GL_PATH_COMMAND_COUNT_NV: [const] int32          = 0x909D;
GL_PATH_COORD_COUNT_NV: [const] int32            = 0x909E;
GL_PATH_DASH_ARRAY_COUNT_NV: [const] int32       = 0x909F;
GL_PATH_COMPUTED_LENGTH_NV: [const] int32        = 0x90A0;
GL_PATH_FILL_BOUNDING_BOX_NV: [const] int32      = 0x90A1;
GL_PATH_STROKE_BOUNDING_BOX_NV: [const] int32    = 0x90A2;
GL_SQUARE_NV: [const] int32                      = 0x90A3;
GL_ROUND_NV: [const] int32                       = 0x90A4;
GL_TRIANGULAR_NV: [const] int32                  = 0x90A5;
GL_BEVEL_NV: [const] int32                       = 0x90A6;
GL_MITER_REVERT_NV: [const] int32                = 0x90A7;
GL_MITER_TRUNCATE_NV: [const] int32              = 0x90A8;
GL_SKIP_MISSING_GLYPH_NV: [const] int32          = 0x90A9;
GL_USE_MISSING_GLYPH_NV: [const] int32           = 0x90AA;
GL_PATH_ERROR_POSITION_NV: [const] int32         = 0x90AB;
GL_ACCUM_ADJACENT_PAIRS_NV: [const] int32        = 0x90AD;
GL_ADJACENT_PAIRS_NV: [const] int32              = 0x90AE;
GL_FIRST_TO_REST_NV: [const] int32               = 0x90AF;
GL_PATH_GEN_MODE_NV: [const] int32               = 0x90B0;
GL_PATH_GEN_COEFF_NV: [const] int32              = 0x90B1;
GL_PATH_GEN_COMPONENTS_NV: [const] int32         = 0x90B3;
GL_PATH_STENCIL_FUNC_NV: [const] int32           = 0x90B7;
GL_PATH_STENCIL_REF_NV: [const] int32            = 0x90B8;
GL_PATH_STENCIL_VALUE_MASK_NV: [const] int32     = 0x90B9;
GL_PATH_STENCIL_DEPTH_OFFSET_FACTOR_NV: [const] int32 = 0x90BD;
GL_PATH_STENCIL_DEPTH_OFFSET_UNITS_NV: [const] int32 = 0x90BE;
GL_PATH_COVER_DEPTH_FUNC_NV: [const] int32       = 0x90BF;
GL_PATH_DASH_OFFSET_RESET_NV: [const] int32      = 0x90B4;
GL_MOVE_TO_RESETS_NV: [const] int32              = 0x90B5;
GL_MOVE_TO_CONTINUES_NV: [const] int32           = 0x90B6;
GL_CLOSE_PATH_NV: [const] int32                  = 0x00;
GL_MOVE_TO_NV: [const] int32                     = 0x02;
GL_RELATIVE_MOVE_TO_NV: [const] int32            = 0x03;
GL_LINE_TO_NV: [const] int32                     = 0x04;
GL_RELATIVE_LINE_TO_NV: [const] int32            = 0x05;
GL_HORIZONTAL_LINE_TO_NV: [const] int32          = 0x06;
GL_RELATIVE_HORIZONTAL_LINE_TO_NV: [const] int32 = 0x07;
GL_VERTICAL_LINE_TO_NV: [const] int32            = 0x08;
GL_RELATIVE_VERTICAL_LINE_TO_NV: [const] int32   = 0x09;
GL_QUADRATIC_CURVE_TO_NV: [const] int32          = 0x0A;
GL_RELATIVE_QUADRATIC_CURVE_TO_NV: [const] int32 = 0x0B;
GL_CUBIC_CURVE_TO_NV: [const] int32              = 0x0C;
GL_RELATIVE_CUBIC_CURVE_TO_NV: [const] int32     = 0x0D;
GL_SMOOTH_QUADRATIC_CURVE_TO_NV: [const] int32   = 0x0E;
GL_RELATIVE_SMOOTH_QUADRATIC_CURVE_TO_NV: [const] int32 = 0x0F;
GL_SMOOTH_CUBIC_CURVE_TO_NV: [const] int32       = 0x10;
GL_RELATIVE_SMOOTH_CUBIC_CURVE_TO_NV: [const] int32 = 0x11;
GL_SMALL_CCW_ARC_TO_NV: [const] int32            = 0x12;
GL_RELATIVE_SMALL_CCW_ARC_TO_NV: [const] int32   = 0x13;
GL_SMALL_CW_ARC_TO_NV: [const] int32             = 0x14;
GL_RELATIVE_SMALL_CW_ARC_TO_NV: [const] int32    = 0x15;
GL_LARGE_CCW_ARC_TO_NV: [const] int32            = 0x16;
GL_RELATIVE_LARGE_CCW_ARC_TO_NV: [const] int32   = 0x17;
GL_LARGE_CW_ARC_TO_NV: [const] int32             = 0x18;
GL_RELATIVE_LARGE_CW_ARC_TO_NV: [const] int32    = 0x19;
GL_RESTART_PATH_NV: [const] int32                = 0xF0;
GL_DUP_FIRST_CUBIC_CURVE_TO_NV: [const] int32    = 0xF2;
GL_DUP_LAST_CUBIC_CURVE_TO_NV: [const] int32     = 0xF4;
GL_RECT_NV: [const] int32                        = 0xF6;
GL_CIRCULAR_CCW_ARC_TO_NV: [const] int32         = 0xF8;
GL_CIRCULAR_CW_ARC_TO_NV: [const] int32          = 0xFA;
GL_CIRCULAR_TANGENT_ARC_TO_NV: [const] int32     = 0xFC;
GL_ARC_TO_NV: [const] int32                      = 0xFE;
GL_RELATIVE_ARC_TO_NV: [const] int32             = 0xFF;
GL_BOLD_BIT_NV: [const] int32                    = 0x01;
GL_ITALIC_BIT_NV: [const] int32                  = 0x02;
GL_GLYPH_WIDTH_BIT_NV: [const] int32             = 0x01;
GL_GLYPH_HEIGHT_BIT_NV: [const] int32            = 0x02;
GL_GLYPH_HORIZONTAL_BEARING_X_BIT_NV: [const] int32 = 0x04;
GL_GLYPH_HORIZONTAL_BEARING_Y_BIT_NV: [const] int32 = 0x08;
GL_GLYPH_HORIZONTAL_BEARING_ADVANCE_BIT_NV: [const] int32 = 0x10;
GL_GLYPH_VERTICAL_BEARING_X_BIT_NV: [const] int32 = 0x20;
GL_GLYPH_VERTICAL_BEARING_Y_BIT_NV: [const] int32 = 0x40;
GL_GLYPH_VERTICAL_BEARING_ADVANCE_BIT_NV: [const] int32 = 0x80;
GL_GLYPH_HAS_KERNING_BIT_NV: [const] int32       = 0x100;
GL_FONT_X_MIN_BOUNDS_BIT_NV: [const] int32       = 0x00010000;
GL_FONT_Y_MIN_BOUNDS_BIT_NV: [const] int32       = 0x00020000;
GL_FONT_X_MAX_BOUNDS_BIT_NV: [const] int32       = 0x00040000;
GL_FONT_Y_MAX_BOUNDS_BIT_NV: [const] int32       = 0x00080000;
GL_FONT_UNITS_PER_EM_BIT_NV: [const] int32       = 0x00100000;
GL_FONT_ASCENDER_BIT_NV: [const] int32           = 0x00200000;
GL_FONT_DESCENDER_BIT_NV: [const] int32          = 0x00400000;
GL_FONT_HEIGHT_BIT_NV: [const] int32             = 0x00800000;
GL_FONT_MAX_ADVANCE_WIDTH_BIT_NV: [const] int32  = 0x01000000;
GL_FONT_MAX_ADVANCE_HEIGHT_BIT_NV: [const] int32 = 0x02000000;
GL_FONT_UNDERLINE_POSITION_BIT_NV: [const] int32 = 0x04000000;
GL_FONT_UNDERLINE_THICKNESS_BIT_NV: [const] int32 = 0x08000000;
GL_FONT_HAS_KERNING_BIT_NV: [const] int32        = 0x10000000;
GL_ROUNDED_RECT_NV: [const] int32                = 0xE8;
GL_RELATIVE_ROUNDED_RECT_NV: [const] int32       = 0xE9;
GL_ROUNDED_RECT2_NV: [const] int32               = 0xEA;
GL_RELATIVE_ROUNDED_RECT2_NV: [const] int32      = 0xEB;
GL_ROUNDED_RECT4_NV: [const] int32               = 0xEC;
GL_RELATIVE_ROUNDED_RECT4_NV: [const] int32      = 0xED;
GL_ROUNDED_RECT8_NV: [const] int32               = 0xEE;
GL_RELATIVE_ROUNDED_RECT8_NV: [const] int32      = 0xEF;
GL_RELATIVE_RECT_NV: [const] int32               = 0xF7;
GL_FONT_GLYPHS_AVAILABLE_NV: [const] int32       = 0x9368;
GL_FONT_TARGET_UNAVAILABLE_NV: [const] int32     = 0x9369;
GL_FONT_UNAVAILABLE_NV: [const] int32            = 0x936A;
GL_FONT_UNINTELLIGIBLE_NV: [const] int32         = 0x936B;
GL_CONIC_CURVE_TO_NV: [const] int32              = 0x1A;
GL_RELATIVE_CONIC_CURVE_TO_NV: [const] int32     = 0x1B;
GL_FONT_NUM_GLYPH_INDICES_BIT_NV: [const] int32  = 0x20000000;
GL_STANDARD_FONT_FORMAT_NV: [const] int32        = 0x936C;
GL_PATH_PROJECTION_NV: [const] int32             = 0x1701;
GL_PATH_MODELVIEW_NV: [const] int32              = 0x1700;
GL_PATH_MODELVIEW_STACK_DEPTH_NV: [const] int32  = 0x0BA3;
GL_PATH_MODELVIEW_MATRIX_NV: [const] int32       = 0x0BA6;
GL_PATH_MAX_MODELVIEW_STACK_DEPTH_NV: [const] int32 = 0x0D36;
GL_PATH_TRANSPOSE_MODELVIEW_MATRIX_NV: [const] int32 = 0x84E3;
GL_PATH_PROJECTION_STACK_DEPTH_NV: [const] int32 = 0x0BA4;
GL_PATH_PROJECTION_MATRIX_NV: [const] int32      = 0x0BA7;
GL_PATH_MAX_PROJECTION_STACK_DEPTH_NV: [const] int32 = 0x0D38;
GL_PATH_TRANSPOSE_PROJECTION_MATRIX_NV: [const] int32 = 0x84E4;
GL_FRAGMENT_INPUT_NV: [const] int32              = 0x936D;
...
GL_SHARED_EDGE_NV: [const] int32                 = 0xC0;

GL_SHADING_RATE_IMAGE_PER_PRIMITIVE_NV: [const] int32 = 0x95B1;
GL_SHADING_RATE_IMAGE_PALETTE_COUNT_NV: [const] int32 = 0x95B2;

GL_REPRESENTATIVE_FRAGMENT_TEST_NV: [const] int32 = 0x937F;

GL_SAMPLE_LOCATION_SUBPIXEL_BITS_NV: [const] int32 = 0x933D;
GL_SAMPLE_LOCATION_PIXEL_GRID_WIDTH_NV: [const] int32 = 0x933E;
GL_SAMPLE_LOCATION_PIXEL_GRID_HEIGHT_NV: [const] int32 = 0x933F;
GL_PROGRAMMABLE_SAMPLE_LOCATION_TABLE_SIZE_NV: [const] int32 = 0x9340;
GL_SAMPLE_LOCATION_NV: [const] int32             = 0x8E50;
GL_PROGRAMMABLE_SAMPLE_LOCATION_NV: [const] int32 = 0x9341;
GL_FRAMEBUFFER_PROGRAMMABLE_SAMPLE_LOCATIONS_NV: [const] int32 = 0x9342;
GL_FRAMEBUFFER_SAMPLE_LOCATION_PIXEL_GRID_NV: [const] int32 = 0x9343;
...
GL_SCISSOR_TEST_EXCLUSIVE_NV: [const] int32      = 0x9555;
GL_SCISSOR_BOX_EXCLUSIVE_NV: [const] int32       = 0x9556;
...
GL_BUFFER_GPU_ADDRESS_NV: [const] int32          = 0x8F1D;
GL_GPU_ADDRESS_NV: [const] int32                 = 0x8F34;
GL_MAX_SHADER_BUFFER_ADDRESS_NV: [const] int32   = 0x8F35;
...
GL_SHADER_GLOBAL_ACCESS_BARRIER_BIT_NV: [const] int32 = 0x00000010;

GL_SUBGROUP_FEATURE_PARTITIONED_BIT_NV: [const] int32 = 0x00000100;

GL_WARP_SIZE_NV: [const] int32                   = 0x9339;
GL_WARPS_PER_SM_NV: [const] int32                = 0x933A;
GL_SM_COUNT_NV: [const] int32                    = 0x933B;

GL_SHADING_RATE_IMAGE_NV: [const] int32          = 0x9563;
GL_SHADING_RATE_NO_INVOCATIONS_NV: [const] int32 = 0x9564;
GL_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV: [const] int32 = 0x9565;
GL_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV: [const] int32 = 0x9566;
GL_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV: [const] int32 = 0x9567;
GL_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV: [const] int32 = 0x9568;
GL_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV: [const] int32 = 0x9569;
GL_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV: [const] int32 = 0x956A;
GL_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV: [const] int32 = 0x956B;
GL_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV: [const] int32 = 0x956C;
GL_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV: [const] int32 = 0x956D;
GL_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV: [const] int32 = 0x956E;
GL_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV: [const] int32 = 0x956F;
GL_SHADING_RATE_IMAGE_BINDING_NV: [const] int32  = 0x955B;
GL_SHADING_RATE_IMAGE_TEXEL_WIDTH_NV: [const] int32 = 0x955C;
GL_SHADING_RATE_IMAGE_TEXEL_HEIGHT_NV: [const] int32 = 0x955D;
GL_SHADING_RATE_IMAGE_PALETTE_SIZE_NV: [const] int32 = 0x955E;
GL_MAX_COARSE_FRAGMENT_SAMPLES_NV: [const] int32 = 0x955F;
GL_SHADING_RATE_SAMPLE_ORDER_DEFAULT_NV: [const] int32 = 0x95AE;
GL_SHADING_RATE_SAMPLE_ORDER_PIXEL_MAJOR_NV: [const] int32 = 0x95AF;
GL_SHADING_RATE_SAMPLE_ORDER_SAMPLE_MAJOR_NV: [const] int32 = 0x95B0;
...
GL_UNIFORM_BUFFER_UNIFIED_NV: [const] int32      = 0x936E;
GL_UNIFORM_BUFFER_ADDRESS_NV: [const] int32      = 0x936F;
GL_UNIFORM_BUFFER_LENGTH_NV: [const] int32       = 0x9370;
...
GL_VERTEX_ATTRIB_ARRAY_UNIFIED_NV: [const] int32 = 0x8F1E;
GL_ELEMENT_ARRAY_UNIFIED_NV: [const] int32       = 0x8F1F;
GL_VERTEX_ATTRIB_ARRAY_ADDRESS_NV: [const] int32 = 0x8F20;
GL_VERTEX_ARRAY_ADDRESS_NV: [const] int32        = 0x8F21;
GL_NORMAL_ARRAY_ADDRESS_NV: [const] int32        = 0x8F22;
GL_COLOR_ARRAY_ADDRESS_NV: [const] int32         = 0x8F23;
GL_INDEX_ARRAY_ADDRESS_NV: [const] int32         = 0x8F24;
GL_TEXTURE_COORD_ARRAY_ADDRESS_NV: [const] int32 = 0x8F25;
GL_EDGE_FLAG_ARRAY_ADDRESS_NV: [const] int32     = 0x8F26;
GL_SECONDARY_COLOR_ARRAY_ADDRESS_NV: [const] int32 = 0x8F27;
GL_FOG_COORD_ARRAY_ADDRESS_NV: [const] int32     = 0x8F28;
GL_ELEMENT_ARRAY_ADDRESS_NV: [const] int32       = 0x8F29;
GL_VERTEX_ATTRIB_ARRAY_LENGTH_NV: [const] int32  = 0x8F2A;
GL_VERTEX_ARRAY_LENGTH_NV: [const] int32         = 0x8F2B;
GL_NORMAL_ARRAY_LENGTH_NV: [const] int32         = 0x8F2C;
GL_COLOR_ARRAY_LENGTH_NV: [const] int32          = 0x8F2D;
GL_INDEX_ARRAY_LENGTH_NV: [const] int32          = 0x8F2E;
GL_TEXTURE_COORD_ARRAY_LENGTH_NV: [const] int32  = 0x8F2F;
GL_EDGE_FLAG_ARRAY_LENGTH_NV: [const] int32      = 0x8F30;
GL_SECONDARY_COLOR_ARRAY_LENGTH_NV: [const] int32 = 0x8F31;
GL_FOG_COORD_ARRAY_LENGTH_NV: [const] int32      = 0x8F32;
GL_ELEMENT_ARRAY_LENGTH_NV: [const] int32        = 0x8F33;
GL_DRAW_INDIRECT_UNIFIED_NV: [const] int32       = 0x8F40;
GL_DRAW_INDIRECT_ADDRESS_NV: [const] int32       = 0x8F41;
GL_DRAW_INDIRECT_LENGTH_NV: [const] int32        = 0x8F42;
...
GL_VIEWPORT_SWIZZLE_POSITIVE_X_NV: [const] int32 = 0x9350;
GL_VIEWPORT_SWIZZLE_NEGATIVE_X_NV: [const] int32 = 0x9351;
GL_VIEWPORT_SWIZZLE_POSITIVE_Y_NV: [const] int32 = 0x9352;
GL_VIEWPORT_SWIZZLE_NEGATIVE_Y_NV: [const] int32 = 0x9353;
GL_VIEWPORT_SWIZZLE_POSITIVE_Z_NV: [const] int32 = 0x9354;
GL_VIEWPORT_SWIZZLE_NEGATIVE_Z_NV: [const] int32 = 0x9355;
GL_VIEWPORT_SWIZZLE_POSITIVE_W_NV: [const] int32 = 0x9356;
GL_VIEWPORT_SWIZZLE_NEGATIVE_W_NV: [const] int32 = 0x9357;
GL_VIEWPORT_SWIZZLE_X_NV: [const] int32          = 0x9358;
GL_VIEWPORT_SWIZZLE_Y_NV: [const] int32          = 0x9359;
GL_VIEWPORT_SWIZZLE_Z_NV: [const] int32          = 0x935A;
GL_VIEWPORT_SWIZZLE_W_NV: [const] int32          = 0x935B;
...
GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_NUM_VIEWS_OVR: [const] int32 = 0x9630;
GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_BASE_VIEW_INDEX_OVR: [const] int32 = 0x9632;
GL_MAX_VIEWS_OVR: [const] int32                  = 0x9631;
GL_FRAMEBUFFER_INCOMPLETE_VIEW_TARGETS_OVR: [const] int32 = 0x9633;
